 ...
 * User Visit Tracker
 */
class Apollo_User_Visit_Tracker {

	/**
	 * Initialize
	 */
	public static function init() {
		add_action( 'template_redirect', [ __CLASS__, 'track_visit' ], 20 );
	}
	...
	private static function get_tracking_mode( $viewer_id, $viewed_user_id ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter
		...
		$settings = get_option( 'apollo_unified_settings', [] );
		$role = $viewer->roles[0];
...
Apollo_User_Visit_Tracker::init();
