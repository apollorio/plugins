...
class Apollo_QA_Audit_Runner {
	...
	private $audit_items = [
		...
		'notifygroups'        => [
			...
			'milestone' => 'Chat',
			'priority'  => 'P2',
			'paths'    => [ 'apollo-social/src/Modules/Chat', 'apollo-social/src/Modules/Groups' ],
		],
		'groups'              => [
			'name'     => 'Groups (nucleo)',
			'milestone' => 'Groups',
			'priority'  => 'P2',
			'paths'    => [ 'apollo-social/src/Modules/Groups', 'apollo-social/src/API/Endpoints/GroupsEndpoint.php' ],
		],
		'quiz-word-doc'        => [
			'name'     => 'Quiz Word Doc',
			'milestone' => 'Register',
			'priority'  => 'P2',
			'paths'    => [ 'apollo-core/includes/quiz', 'apollo-core/tests/test-registration-quiz.php' ],
		],
		'mod-panel'           => [
			'name'     => 'MOD Panel',
			'milestone' => 'Sign Doc',
			'priority'  => 'P3',
			'paths'    => [ 'apollo-core/modules/moderation', 'apollo-social/src/Modules/Moderation' ],
		],
		'emailing-alert'      => [
			'name'     => 'Plus Emailing Alert System',
			'milestone' => 'Coautor',
			'priority'  => 'P2',
			'paths'    => [ 'apollo-core/includes/class-apollo-email-integration.php', 'apollo-social/src/Email' ],
		],
		'profile-page'        => [
			'name'     => 'Profile Page',
			'milestone' => 'Builder',
			'priority'  => 'P3',
			'paths'    => [ 'apollo-social/user-pages', 'apollo-social/templates/user-page-view.php' ],
		],
	];
	...
	private function smoke_test_emailing() {
		if ( ! class_exists( 'Apollo_Email_Integration' ) ) {
			return '❌ Failed';
		}
		return '✅ Passed';
	}
