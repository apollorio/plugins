...
(function($) {
	...
	$(document).ready(function() {
		...
		$('.apollo-toggle-all').on('change', function() {
		...
		// Suspend user
		$('.apollo-suspend-user').on('click', function() {
		...
		// Test email
		$('.apollo-test-email, .apollo-send-test-email').on('click', function() {
		...
		// Toggle feature
		$('.apollo-feature-toggle').on('change', function() {
