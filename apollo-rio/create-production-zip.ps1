# Script de Criação de ZIP para Produção - Apollo Rio
# Execute este script na pasta wp-content/plugins/

Write-Host "🚀 Preparando Apollo Rio para Produção..." -ForegroundColor Green
Write-Host ""

# Verificar se estamos na pasta correta
if (-not (Test-Path "apollo-rio\apollo-rio.php")) {
...
# Nome do arquivo ZIP
$version = "1.0.0"
$zipName = "apollo-rio-v$version-production.zip"
$pluginDir = "apollo-rio"
...
try {
    ...
    $requiredFiles = @(
        "apollo-rio.php",
        "includes\class-pwa-page-builders.php",
        "includes\template-functions.php",
    ...
    if ($allPresent) {
        ...
        Write-Host "5. Testar PWA detection e templates" -ForegroundColor White
    } else {
