...
function apollo_render_pwa_install_page() {
    ...
    <div class="apollo-pwa-install-page">
        <div class="apollo-pwa-container">
            ...
            <p class="apollo-pwa-subtitle">
                <?php _e("Se você ainda não tem, baixe", 'apollo-rio'); ?> 
            ...
            <div id="apollo-pwa-accordion" class="apollo-pwa-accordion" style="display: none;">
                ...
                <!-- iOS Option -->
                <div class="apollo-pwa-accordion-item">
                    <button class="apollo-pwa-accordion-button" data-target="ios-content">
                        <span class="apollo-pwa-platform-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div id="ios-content" class="apollo-pwa-accordion-content">
                        <div class="apollo-pwa-ios-instructions">
                            <h3><?php _e('Como instalar no iOS/iPhone:', 'apollo-rio'); ?></h3>
                            <ol>
                                <li>
                                    <strong><?php _e('Abra no Safari', 'apollo-rio'); ?></strong>
                                    <p><?php _e('Este app funciona melhor no navegador Safari', 'apollo-rio'); ?></p>
                                </li>
                                <li>
                                    <strong><?php _e('Toque no botão Compartilhar', 'apollo-rio'); ?></strong>
                                    ...
                                    <p><?php _e('Procure pelo ícone de compartilhar na parte inferior do Safari', 'apollo-rio'); ?></p>
                                </li>
                                <li>
                                    <strong><?php _e('Selecione "Adicionar à Tela de Início"', 'apollo-rio'); ?></strong>
                                    <div class="apollo-pwa-icon-demo">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <p><?php _e('Role para baixo e toque em "Adicionar à Tela de Início"', 'apollo-rio'); ?></p>
                                </li>
                                <li>
                                    <strong><?php _e('Toque em "Adicionar"', 'apollo-rio'); ?></strong>
                                    <p><?php _e('Confirme tocando em "Adicionar" no canto superior direito', 'apollo-rio'); ?></p>
                                </li>
                                <li>
                                    <strong><?php _e('Abra da Tela de Início', 'apollo-rio'); ?></strong>
                                    <p><?php _e('O ícone do app aparecerá na sua tela de início. Toque para abrir!', 'apollo-rio'); ?></p>
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('apollo-pwa-get-app').addEventListener('click', function(e) {
            e.preventDefault();
