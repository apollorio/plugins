	...
	<div class="wrap">
			...
			<ol style="line-height: 1.8;">
				...
				<li>
					...
					<ul style="margin-top: 10px; margin-left: 20px;">
						...
						<li><strong>Apollo-APP</strong> - <?php esc_html_e('Página do app com navbar oficial (Apollo Core)', 'apollo-rio'); ?></li>
		...
		<table class="widefat" style="margin-top: 20px;">
			...
			<tbody>
				...
				<tr>
					<td><strong>Apollo-APP</strong></td>
					<td><?php esc_html_e('Full (Apollo Core navbar)', 'apollo-rio'); ?></td>
					<td>✅ <?php esc_html_e('Content', 'apollo-rio'); ?></td>
					<td>✅ <?php esc_html_e('Content', 'apollo-rio'); ?></td>
					<td>✅ <?php esc_html_e('Content', 'apollo-rio'); ?></td>
				</tr>
		...
		<div class="notice notice-info" style="margin-top: 20px;">
			<p>
				...
				<br>
				<?php esc_html_e('O template "Apollo-APP" usa a navbar oficial (Apollo Core, quando ativo) e mantém o conteúdo visível em todas as plataformas.', 'apollo-rio'); ?>
			</p>
		</div>
	</div>
<?php
