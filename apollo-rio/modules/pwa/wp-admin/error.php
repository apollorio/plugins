...
// Prevent wp_die() from breaking frontend map page
if ( ! is_admin() && ( is_page('mapa') || strpos($_SERVER['REQUEST_URI'], '/mapa/') !== false ) ) {
    return;
}

wp_die($content, $admin_title, [ 'response' => 200 ]); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
