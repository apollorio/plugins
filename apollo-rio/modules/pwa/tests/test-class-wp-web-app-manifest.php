...
class Test_WP_Web_App_Manifest extends TestCase
{
     ...
     * @var string
     */
    public const MOCK_BACKGROUND_COLOR = '#003001';
     ...
     * @var string
     */
    public const MOCK_THEME_COLOR = '#422508';
     ...
     * @var string
     */
    public const EXPECTED_ROUTE = '/wp/v2/web-app-manifest';
    ...
    public function tear_down()
    {
        ...
        remove_filter('pwa_background_color', [ $this, 'mock_background_color' ]);
        remove_filter('rest_api_init', [ $this->instance, 'register_manifest_rest_route' ]);
        parent::tear_down();
    }
    ...
    public function test_init()
    {
        ...
        $this->assertEquals(10, has_action('wp_head', [ $this->instance, 'manifest_link_and_meta' ]));
        $this->assertEquals(10, has_action('rest_api_init', [ $this->instance, 'register_manifest_rest_route' ]));

        $this->assertEquals(10, has_action('rest_api_init', [ $this->instance, 'register_short_name_setting' ]));
        $this->assertEquals(10, has_action('admin_init', [ $this->instance, 'register_short_name_setting' ]));
        $this->assertEquals(10, has_action('admin_init', [ $this->instance, 'add_short_name_settings_field' ]));
    }
    ...
    public function test_get_manifest()
    {
        ...
        add_filter('web_app_manifest', [ $this, 'mock_manifest' ]);
        $actual_manifest = $this->instance->get_manifest();
    ...
    public function get_data_to_test_get_manifest_short_name()
    {
        ...
        return [
            'long_blogname'             => [ $set_long_blogname, null ],
            'short_blogname'            => [ $set_short_blogname, 'WP Dev' ],
            'short_blogname_whitespace' => [ $set_short_blogname_with_whitespace, 'WP Dev' ],
            'short_name_option'         => [
    ...
    {
        add_action('rest_api_init', [ $this->instance, 'register_manifest_rest_route' ]);
        ...
        $this->assertEquals([ $this->instance, 'rest_serve_manifest' ], $route['callback']);
        $this->assertEquals([ $this->instance, 'rest_permission' ], $route['permission_callback']);
    }
    ...
    public function test_get_icons()
    {
        ...
        $this->assertEquals([], $this->instance->get_icons());
    ...
    public function test_register_short_name_setting()
    {
        ...
        $this->assertEquals([ $this->instance, 'sanitize_short_name' ], $setting['sanitize_callback']);
    ...
    public function test_add_short_name_settings_field()
    {
        ...
        $this->assertEquals([ $this->instance, 'render_short_name_settings_field' ], $field['callback']);
    }
    ...
    public function get_data_to_test_sanitize_short_name()
    {
        return [
            ...
            'array'              => [ [], '' ],
            'string'             => [ '', '' ],
            'whitespace_padding' => [ '     WP Dev ', 'WP Dev' ],
            'script_contains'    => [ 'WP <script>evil</script> Dev ', 'WP Dev' ],
            'too_long'           => [ 'WordPress Develop', 'WordPress De' ],
            'multi-byte'         => [ 'On the Rhône', 'On the Rhône' ],
            'emoji'              => [ '👌👌👌👌👌👌👌👌👌👌👌👌👌👌', '👌👌👌👌👌👌👌👌👌👌👌👌' ], // 👌 takes 4 bytes.
        ];
    }
    ...
    {
        $setup();
        $output = trim(get_echo([ $this->instance, 'render_short_name_settings_field' ]));
