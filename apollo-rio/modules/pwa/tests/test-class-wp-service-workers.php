...
class Test_WP_Service_Workers extends TestCase
{
    ...
    {
        add_action('wp_front_service_worker', [ $this, 'register_bar_sw' ]);
        add_action('wp_admin_service_worker', [ $this, 'register_baz_sw' ]);
        add_action('wp_front_service_worker', [ $this, 'register_foo_sw' ]);
        add_action('wp_admin_service_worker', [ $this, 'register_foo_sw' ]);
    ...
    public function test_serve_request_bad_src_callback()
    {
        wp_register_service_worker_script(
            'bar',
            [
                'src' => [ 'Does_Not_Exist', 'return_bar_sw' ],
            ]
        );
