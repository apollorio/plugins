...
foreach ([ 'wp_print_footer_scripts', 'admin_print_scripts', 'customize_controls_print_scripts', 'login_footer', 'after_signup_form', 'activate_wp_head' ] as $filter) {
...
if (version_compare(strtok(get_bloginfo('version'), '-'), '5.7', '>=')) {
    add_action('error_head', 'wp_robots', 1);
    // To match wp_robots running at wp_head.
