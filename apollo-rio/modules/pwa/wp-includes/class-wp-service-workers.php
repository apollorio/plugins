...
final class WP_Service_Workers
{
     ...
     * @var string
     */
    public const QUERY_VAR = 'wp_service_worker';
    ...
    public function serve_request()
    {
        ...
        ob_start();
        // Start guarding against themes/plugins printing anything at wp_enqueue_scripts admin_enqueue_scripts.
        if (! is_admin()) {
            wp_enqueue_scripts();
        ...
        ob_end_clean();
        // Finish guarding against themes/plugins printing anything at wp_enqueue_scripts admin_enqueue_scripts.
