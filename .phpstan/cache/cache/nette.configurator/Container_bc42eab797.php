...
class Container_bc42eab797 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_bc42eab797 $container)
			{
	...
	public function createServiceContainer(): Container_bc42eab797
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '50',
				'PHPRC' => 'C:\Users\rafae\AppData\Local\Temp\ABB7.tmp',
				...
				'WINDIR' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\rafae\AppData\Local\Temp\ABB7.tmp|0|*|*|C:\Users\rafae\AppData\Roaming\Local\lightning-services\php-8.3.23+0\bin\win64\php.ini|3.3.0',
