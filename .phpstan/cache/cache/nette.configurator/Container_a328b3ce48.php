...
class Container_a328b3ce48 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a328b3ce48 $container)
			{
	...
	public function createServiceContainer(): Container_a328b3ce48
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\apollo-email-newsletter',
				'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\apollo-email-templates',
				'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\apollo-rio',
			],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'LINES' => '50',
				'PHPRC' => 'C:\Users\rafae\AppData\Local\Temp\7BDB.tmp',
				...
				'WINDIR' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\rafae\AppData\Local\Temp\7BDB.tmp|0|*|*|C:\Users\rafae\AppData\Roaming\Local\lightning-services\php-8.3.23+0\bin\win64\php.ini|3.3.0',
