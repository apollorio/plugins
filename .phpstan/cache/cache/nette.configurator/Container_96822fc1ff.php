...
class Container_96822fc1ff extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_96822fc1ff $container)
			{
	...
	public function createServiceContainer(): Container_96822fc1ff
	{
		return $this;
	}
