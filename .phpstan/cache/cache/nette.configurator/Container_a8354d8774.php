...
class Container_a8354d8774 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0412' => true, '0815' => true],
	...
	protected $wiring = [
		...
		'SzepeViktor\PHPStan\WordPress\HookCallbackRule' => [['rules.0']],
		'SzepeViktor\PHPStan\WordPress\HookDocsRule' => [['rules.1']],
		'SzepeViktor\PHPStan\WordPress\WpConstantFetchRule' => [['rules.2']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0412', '0815']],
		...
		'SzepeViktor\PHPStan\WordPress\HookDocBlock' => [['0805']],
		'SzepeViktor\PHPStan\WordPress\ApplyFiltersDynamicFunctionReturnTypeExtension' => [['0806']],
		'SzepeViktor\PHPStan\WordPress\EscSqlDynamicFunctionReturnTypeExtension' => [['0807']],
		'SzepeViktor\PHPStan\WordPress\NormalizeWhitespaceDynamicFunctionReturnTypeExtension' => [['0808']],
		'SzepeViktor\PHPStan\WordPress\ShortcodeAttsDynamicFunctionReturnTypeExtension' => [['0809']],
		'SzepeViktor\PHPStan\WordPress\StripslashesFromStringsOnlyDynamicFunctionReturnTypeExtension' => [['0810']],
		'SzepeViktor\PHPStan\WordPress\SlashitFunctionsDynamicFunctionReturnTypeExtension' => [['0811']],
		'SzepeViktor\PHPStan\WordPress\WpParseUrlFunctionDynamicReturnTypeExtension' => [['0812']],
		'SzepeViktor\PHPStan\WordPress\WpSlashDynamicFunctionReturnTypeExtension' => [['0813']],
		'SzepeViktor\PHPStan\WordPress\HookDocsVisitor' => [['0814']],
		'SzepeViktor\PHPStan\WordPress\AssertWpErrorTypeSpecifyingExtension' => [['0815']],
	];
	...
	{
		return new PHPStan\Analyser\Generator\StmtHandler\IfHandler(false);
	}
	...
	public function createService052(): PHPStan\Analyser\Generator\StmtHandler\ExpressionHandler
	{
		return new PHPStan\Analyser\Generator\StmtHandler\ExpressionHandler(
			$this->getService('reflectionProvider'),
			['IXR_Server' => ['output'], 'WP_Ajax_Response' => ['send']],
			['wp_send_json', 'wp_nonce_ays']
		);
	}
	...
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('0180'), false);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0165'), $this->getService('0169'), true, false);
	}
	...
	public function createService0420(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			$this->getParameter('analysedPathsFromConfig'),
			'6',
			'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\phpstan-baseline.neon',
			null,
			$this->getParameter('singleReflectionFile'),
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['C:/Users/rafae/Local Sites/1212/app/public/wp-content/plugins']);
	}
	...
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['C:/Users/rafae/Local Sites/1212/app/public/wp-content/plugins']);
	}
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a8354d8774 $container)
			{
	...
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('0181'), false, true);
	}


	public function createService0487(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('0181'), false, false, true);
	}


	public function createService0488(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0180'), false, false, true);
	}
	...
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('0181'), false, false, true);
	}


	public function createService0491(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('0181'), false, true);
	}


	public function createService0492(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0180'), false, false, true);
	}


	public function createService0493(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule($this->getService('0181'), false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0180'), false, false, true);
	}


	public function createService0497(): PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('0181'), false, true);
	}


	public function createService0498(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('0181'), false, true);
	}


	public function createService0499(): PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('0181'), false, true);
	}


	public function createService0500(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('0181'), false, false, true);
	}


	public function createService0501(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('0181'), false, false, true);
	}


	public function createService0502(): PHPStan\Rules\Comparison\LogicalXorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\LogicalXorConstantConditionRule($this->getService('0181'), false, false, true);
	}


	public function createService0503(): PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule
	{
		return new PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule($this->getService('0110'), false, false, true);
	}
	...
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule($this->getService('0185'), false, false, true);
	}
	...
	public function createServiceContainer(): Container_a8354d8774
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\wpem-*',
				'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\cena-*',
				'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\tropicalis-*',
			],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'earlyTerminatingMethodCalls' => ['IXR_Server' => ['output'], 'WP_Ajax_Response' => ['send']],
			'earlyTerminatingFunctionCalls' => ['wp_send_json', 'wp_nonce_ays'],
			...
			'composerAutoloaderProjectPaths' => ['C:/Users/rafae/Local Sites/1212/app/public/wp-content/plugins'],
			'generateBaselineFile' => 'C:\Users\rafae\Local Sites\1212\app\public\wp-content\plugins\phpstan-baseline.neon',
			'usedLevel' => '6',
			...
			'env' => [
				...
				'LINES' => '50',
				'PHPRC' => 'C:\Users\rafae\AppData\Local\Temp\2767.tmp',
				...
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_27772_KQLDBBJBITGSXIBC',
				...
				'CURSOR_AGENT' => '1',
				'CURSOR_TRACE_ID' => 'bfdd8a8584be45aea9770835fbbc637a',
				...
				'OLDPWD' => 'C:/Users/rafae/Local Sites/1212/app/public/wp-content/plugins',
				...
				'PWD' => 'C:/Users/rafae/Local Sites/1212/app/public/wp-content/plugins',
				...
				'VSCODE_GIT_IPC_AUTH_TOKEN' => '7c7e336258eff6cf2d819f4d69338bccc640466423c784233c35cf05cf618944',
				'VSCODE_GIT_IPC_HANDLE' => '\\\.\pipe\vscode-git-57ea046cd4-sock',
				'WINDIR' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\rafae\AppData\Local\Temp\2767.tmp|0|*|*|C:\Users\rafae\AppData\Roaming\Local\lightning-services\php-8.3.23+0\bin\win64\php.ini|3.3.0',
				'_' => 'C:/Users/rafae/AppData/Roaming/Local/lightning-services/php-8.3.23+0/bin/win64/php',
				'npm_config_yes' => 'true',
			],
		];
	}
