...
class Container_0eaf6acb1c extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_0eaf6acb1c $container)
			{
	...
	public function createServiceContainer(): Container_0eaf6acb1c
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '50',
				'PHPRC' => 'C:\Users\rafae\AppData\Local\Temp\BEB3.tmp',
				...
				'WINDIR' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\rafae\AppData\Local\Temp\BEB3.tmp|0|*|*|C:\Users\rafae\AppData\Roaming\Local\lightning-services\php-8.3.23+0\bin\win64\php.ini|3.3.0',
