...
class CenaRioEventEndpoint
{
    ...
    public function registerRoutes(): void
    {
        ...
        register_rest_route('apollo/v1', '/cena-rio/event', [
        ...
        register_rest_route('apollo/v1', '/cena-rio/event/(?P<id>\d+)/approve', [
            'methods' => WP_REST_Server::CREATABLE,
    ...
    public function createEvent(WP_REST_Request $request): WP_REST_Response
    {
        ...
        $event_id = wp_insert_post([
            ...
            'post_status' => 'draft', // P0-10: Always draft for moderation
