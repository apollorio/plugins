...
class MediaEmbedHelper {
	 ...
	 */
	public static function renderSpotifyEmbed( string $id, string $type = 'track', array $attrs = array() ): string {
	 ...
	 */
	public static function renderSoundCloudEmbed( string $url, array $attrs = array() ): string {
		$width     = $attrs['width'] ?? '100%';
