...
class CulturaRioIdentity {
	...
	private static array $identities = array(
		'clubber'           => array(
			'label'            => 'Clubber (Lvl 0) - participativo ou não, agora estamos juntxs!',
			'code'             => 'a',
			'locked'           => true,
			'membership_level' => null,
		),
		'dj_amateur'        => array(
			'label'            => 'DJ (Lvl 1) - aspirante/amador',
			'code'             => 'b',
			'locked'           => false,
			'membership_level' => 'dj_amateur',
		),
		'dj_pro'            => array(
			'label'            => 'DJ (Lvl 2) - profissional',
			'code'             => 'c',
			'locked'           => false,
			'membership_level' => 'dj_professional',
		),
		'producer_dreamer'  => array(
			'label'            => 'Producer de Eventos (Lvl 1) - quero iniciar meu sonho',
			'code'             => 'd',
			'locked'           => false,
			'membership_level' => 'event_producer_starter',
		),
		'producer_starter'  => array(
			'label'            => 'Producer de Eventos (Lvl 2) - iniciando eventos',
			'code'             => 'e',
			'locked'           => false,
			'membership_level' => 'event_producer_active',
		),
		'producer_pro'      => array(
			'label'            => 'Producer de Eventos (Lvl 3) - profissional',
			'code'             => 'f',
			'locked'           => false,
			'membership_level' => 'event_producer_professional',
		),
		'music_producer'    => array(
			'label'            => 'Producer de Música (Lvl 1)',
			'code'             => 'j',
			'locked'           => false,
			'membership_level' => 'music_producer',
		),
		'cultural_producer' => array(
			'label'            => 'Producer Cultural (Lvl 1)',
			'code'             => 'k',
			'locked'           => false,
			'membership_level' => 'cultural_producer',
		),
		'business'          => array(
			'label'            => 'Business Person (Lvl 1)',
			'code'             => 'l',
			'locked'           => false,
			'membership_level' => 'business',
		),
		'government'        => array(
			'label'            => 'Government (Lvl 4)',
			'code'             => 'm',
			'locked'           => false,
			'membership_level' => 'government',
		),
		'promoter'          => array(
			'label'            => 'Promoter (Lvl 1)',
			'code'             => 'n',
			'locked'           => false,
			'membership_level' => 'promoter',
		),
		'visual_artist'     => array(
			'label'            => 'Visual Artist (Lvl 1)',
			'code'             => 'p',
			'locked'           => false,
