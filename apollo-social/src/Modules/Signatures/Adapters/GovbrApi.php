...
class GovbrApi
{
    ...
    public function __construct()
    {
        ...
        $this->environment = get_option('apollo_govbr_environment', 'sandbox'); // sandbox | production
    ...
    private function createQualifiedSignatureRequest(
        ...
        */
        ...
        $expires_at = date('Y-m-d H:i:s', strtotime('+7 days')); // 7 dias para assinatura qualificada
