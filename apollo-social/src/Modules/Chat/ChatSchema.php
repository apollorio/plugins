...
class ChatSchema implements SchemaModuleInterface {
	...
	public function getStatus(): array {
		...
		return array(
			'conversations' => $wpdb->get_var( $wpdb->prepare( 'SHOW TABLES LIKE %s', $conv ) ) === $conv,
			'messages'      => $wpdb->get_var( $wpdb->prepare( 'SHOW TABLES LIKE %s', $msgs ) ) === $msgs,
			'participants'  => $wpdb->get_var( $wpdb->prepare( 'SHOW TABLES LIKE %s', $part ) ) === $part,
		);
	}
