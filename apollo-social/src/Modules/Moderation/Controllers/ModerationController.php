...
class ModerationController {
	...
	public function __construct() {
		...
		\add_action( 'wp_ajax_apollo_mod_queue', array( $this, 'getModerationQueue' ) );
		\add_action( 'wp_ajax_apollo_mod_stats', array( $this, 'getModerationStats' ) );
	}
	...
	public function renderDashboard(): void {
		...
		$queue = $this->modService->getModerationQueue( array( 'status' => 'pending' ) );
