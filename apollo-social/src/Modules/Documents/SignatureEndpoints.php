...
class SignatureEndpoints
{
    ...
    public function registerRoutes(): void
    {
        ...
        register_rest_route(self::NAMESPACE, '/library/(?P<library>[a-z]+)', [
            'methods' => 'GET',
            ...
            'args' => [
                'library' => [
                    'required' => true,
                    'validate_callback' => fn($v) => in_array($v, ['apollo', 'cenario', 'private'])
                ],
                'status' => ['type' => 'string'],
                'type' => ['type' => 'string'],
                'search' => ['type' => 'string'],
        ...
        // Get library stats
        register_rest_route(self::NAMESPACE, '/library/(?P<library>[a-z]+)/stats', [
            'methods' => 'GET',
        ...
        // Create document
        register_rest_route(self::NAMESPACE, '/document', [
            'methods' => 'POST',
        ...
        // Get document
        register_rest_route(self::NAMESPACE, '/document/(?P<file_id>[a-zA-Z0-9]+)', [
            'methods' => 'GET',
        ...
        // Finalize document
        register_rest_route(self::NAMESPACE, '/document/(?P<file_id>[a-zA-Z0-9]+)/finalize', [
            'methods' => 'POST',
        ...
        // Move document
        register_rest_route(self::NAMESPACE, '/document/(?P<file_id>[a-zA-Z0-9]+)/move', [
            'methods' => 'POST',
            'callback' => [$this, 'moveDocument'],
            'permission_callback' => [$this, 'checkAuthenticated'],
            'args' => [
                'target_library' => ['required' => true, 'type' => 'string']
            ]
        ]);
        ...
        register_rest_route(self::NAMESPACE, '/sign/certificate', [
            'methods' => 'POST',
            'callback' => [$this, 'signWithCertificate'],
            'permission_callback' => [$this, 'checkAuthenticated'],
            'args' => [
                'document_id' => ['required' => true, 'type' => 'integer'],
        ...
        register_rest_route(self::NAMESPACE, '/sign/canvas', [
            'methods' => 'POST',
            'callback' => [$this, 'signWithCanvas'],
            'permission_callback' => '__return_true', // Public for external signers
            'args' => [
        ...
        register_rest_route(self::NAMESPACE, '/sign/request', [
            'methods' => 'POST',
        ...
        register_rest_route(self::NAMESPACE, '/verify/protocol/(?P<code>[A-Z0-9-]+)', [
            'methods' => 'GET',
        ...
        register_rest_route(self::NAMESPACE, '/verify/hash', [
            'methods' => 'POST',
        ...
        register_rest_route(self::NAMESPACE, '/verify/file', [
            'methods' => 'POST',
        ...
        register_rest_route(self::NAMESPACE, '/audit/(?P<file_id>[a-zA-Z0-9]+)', [
            'methods' => 'GET',
        ...
        register_rest_route(self::NAMESPACE, '/audit/(?P<file_id>[a-zA-Z0-9]+)/report', [
            'methods' => 'GET',
        ...
        // Generate protocol
        register_rest_route(self::NAMESPACE, '/protocol/generate', [
            'methods' => 'POST',
        ...
        register_rest_route(self::NAMESPACE, '/templates/(?P<file_id>[a-zA-Z0-9]+)/use', [
            'methods' => 'POST',
            'callback' => [$this, 'createFromTemplate'],
            'permission_callback' => [$this, 'checkAuthenticated'],
            'args' => [
                'target_library' => ['type' => 'string', 'default' => 'private']
            ]
        ]);
    }
    ...
    public function signWithCertificate(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        if ($result['success']) {
            ...
            $wpdb->update(
                $documents_table,
                ['status' => 'signing', 'pdf_path' => str_replace(ABSPATH, '/', $result['signed_pdf_path'])],
                ['id' => $document_id]
            );
        }
