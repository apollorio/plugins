...
class AdminHubPage
{
    ...
    private function renderSecurityContent(): void
    {
        ...
        $threats = array_reverse($threats); // Most recent first
        ?>
        <div class="apollo-hub-section">
    ...
    private function getAllShortcodes(): array
    {
        return [
            'Documentos' => [
                ['code' => '[apollo_documents]', 'description' => 'Lista de documentos', 'attributes' => 'library="apollo|cenario|private"'],
                ['code' => '[apollo_document_editor]', 'description' => 'Editor WYSIWYG de documentos', 'attributes' => 'doc_id'],
                ['code' => '[apollo_sign_document]', 'description' => 'Página de assinatura digital', 'attributes' => 'doc_id'],
                ['code' => '[apollo_verify_document]', 'description' => 'Verificar autenticidade de documento', 'attributes' => ''],
            ],
            'Grupos' => [
                ['code' => '[apollo_groups]', 'description' => 'Lista de comunidades e núcleos', 'attributes' => 'type="community|nucleo"'],
                ['code' => '[apollo_group_single]', 'description' => 'Página single de grupo', 'attributes' => 'group_id'],
            ],
            'Perfil e Social' => [
                ['code' => '[apollo_profile]', 'description' => 'Perfil do usuário', 'attributes' => 'user_id'],
                ['code' => '[apollo_profile_card]', 'description' => 'Card compacto de perfil', 'attributes' => 'user_id'],
                ['code' => '[apollo_user_mention]', 'description' => 'Menção de usuário inline', 'attributes' => 'user_id'],
            ],
            'Feed' => [
                ['code' => '[apollo_feed]', 'description' => 'Feed social principal', 'attributes' => ''],
                ['code' => '[apollo_post_form]', 'description' => 'Formulário de criação de post', 'attributes' => ''],
            ],
            'Autenticação' => [
                ...
                ['code' => '[apollo_aptitude_quiz]', 'description' => 'Quiz de aptitude para registro', 'attributes' => ''],
            ],
        ];
    }
    ...
    private function getAllPlaceholders(): array
    {
        return [
            'Usuário' => [
                ...
                ['code' => '{{user_handle}}', 'description' => 'Handle do usuário', 'example' => '@joaosilva'],
                ['code' => '{{user_avatar_url}}', 'description' => 'URL do avatar', 'example' => 'https://...'],
                ['code' => '{{user_permalink}}', 'description' => 'URL do perfil', 'example' => '/perfil/joaosilva'],
                ['code' => '{{is_verified}}', 'description' => 'Se usuário é verificado', 'example' => 'true/false'],
                ['code' => '{{badges}}', 'description' => 'Array de badges', 'example' => "['apollo', 'dj']"],
                ['code' => '{{nucleos}}', 'description' => 'Array de núcleos', 'example' => "['Núcleo Apollo']"],
            ],
            'Documento' => [
                ['code' => '{{doc_title}}', 'description' => 'Título do documento', 'example' => 'Contrato de Serviço'],
                ['code' => '{{doc_protocol}}', 'description' => 'Código do protocolo', 'example' => 'APR-DOC-2025-A1B2C'],
                ['code' => '{{doc_hash}}', 'description' => 'Hash SHA-256', 'example' => 'abc123...'],
                ['code' => '{{doc_status}}', 'description' => 'Status do documento', 'example' => 'draft|ready|signed'],
                ['code' => '{{signer_name}}', 'description' => 'Nome do assinante', 'example' => 'João Silva'],
                ['code' => '{{signer_cpf}}', 'description' => 'CPF mascarado', 'example' => '***.456.789-**'],
            ],
            'Grupo' => [
                ['code' => '{{group_name}}', 'description' => 'Nome do grupo', 'example' => 'Núcleo Apollo'],
                ['code' => '{{group_type}}', 'description' => 'Tipo do grupo', 'example' => 'community|nucleo'],
                ['code' => '{{group_members_count}}', 'description' => 'Número de membros', 'example' => '42'],
                ['code' => '{{group_avatar_url}}', 'description' => 'Avatar do grupo', 'example' => 'https://...'],
            ],
        ];
    }
    ...
    private function getAllForms(): array
    {
        return [
            [
                ...
                'fields' => [
                    ['label' => 'Nome social & Sobrenome', 'type' => 'text', 'required' => true, 'meta_key' => 'display_name'],
                    ['label' => 'Tipo de Documento', 'type' => 'select', 'required' => true, 'meta_key' => 'apollo_doc_type'],
                    ['label' => 'CPF', 'type' => 'cpf', 'required' => false, 'meta_key' => 'apollo_cpf'],
                    ['label' => 'Passaporte', 'type' => 'text', 'required' => false, 'meta_key' => 'apollo_passport'],
                    ['label' => 'E-mail', 'type' => 'email', 'required' => true, 'meta_key' => 'user_email'],
                    ['label' => 'Senha', 'type' => 'password', 'required' => true, 'meta_key' => 'user_pass'],
                    ['label' => 'Gêneros Musicais (SOUNDS)', 'type' => 'multiselect', 'required' => true, 'meta_key' => 'apollo_sounds'],
                    ['label' => 'Quiz de Registro', 'type' => 'quiz', 'required' => true, 'meta_key' => 'apollo_quiz_completed'],
                ],
            ],
            [
            ...
            [
                ...
                'fields' => [
                    ['label' => 'Nome Completo', 'type' => 'text', 'required' => true, 'meta_key' => '—'],
                    ['label' => 'CPF', 'type' => 'cpf', 'required' => true, 'meta_key' => '—'],
                    ['label' => 'Aceitar Termos', 'type' => 'checkbox', 'required' => true, 'meta_key' => '—'],
                    ['label' => 'Assinatura Canvas', 'type' => 'canvas', 'required' => true, 'meta_key' => '—'],
                ],
            ],
        ];
    }
    ...
    private function getAllMetakeys(): array
    {
        return [
            'User Meta' => [
                ['key' => 'apollo_doc_type', 'type' => 'string', 'description' => 'Tipo de documento (cpf|passport)'],
                ['key' => 'apollo_cpf', 'type' => 'string', 'description' => 'CPF do usuário'],
                ['key' => 'apollo_cpf_formatted', 'type' => 'string', 'description' => 'CPF formatado'],
                ['key' => 'apollo_passport', 'type' => 'string', 'description' => 'Número do passaporte'],
                ['key' => 'apollo_passport_country', 'type' => 'string', 'description' => 'País do passaporte'],
                ['key' => 'apollo_can_sign_documents', 'type' => 'bool', 'description' => 'Se pode assinar documentos'],
                ['key' => 'apollo_sounds', 'type' => 'array', 'description' => 'Gêneros musicais preferidos'],
                ['key' => 'apollo_quiz_completed', 'type' => 'bool', 'description' => 'Quiz de registro completado'],
                ['key' => 'apollo_quiz_score', 'type' => 'int', 'description' => 'Pontuação do quiz'],
                ['key' => 'apollo_membership_type', 'type' => 'string', 'description' => 'Tipo de membership'],
                ['key' => 'apollo_badges', 'type' => 'array', 'description' => 'Badges do usuário'],
            ],
            'Documento (apollo_document)' => [
                ['key' => '_apollo_doc_protocol', 'type' => 'string', 'description' => 'Código do protocolo'],
                ['key' => '_apollo_doc_hash', 'type' => 'string', 'description' => 'Hash SHA-256 do conteúdo'],
                ['key' => '_apollo_doc_library', 'type' => 'string', 'description' => 'Biblioteca (apollo|cenario|private)'],
                ['key' => '_apollo_doc_status', 'type' => 'string', 'description' => 'Status (draft|ready|signed)'],
                ['key' => '_apollo_doc_delta', 'type' => 'json', 'description' => 'Conteúdo Delta do Quill'],
            ],
            'Assinatura (apollo_signature)' => [
                ['key' => '_apollo_sig_type', 'type' => 'string', 'description' => 'Tipo (canvas|icp-brasil)'],
                ['key' => '_apollo_sig_signer_id', 'type' => 'int', 'description' => 'ID do assinante'],
                ['key' => '_apollo_sig_cpf', 'type' => 'string', 'description' => 'CPF (criptografado)'],
                ['key' => '_apollo_sig_timestamp', 'type' => 'datetime', 'description' => 'Data/hora UTC'],
                ['key' => '_apollo_sig_ip', 'type' => 'string', 'description' => 'IP do assinante'],
                ['key' => '_apollo_sig_canvas_data', 'type' => 'text', 'description' => 'Imagem da assinatura (base64)'],
            ],
            'Grupo (apollo_group)' => [
                ['key' => '_apollo_group_type', 'type' => 'string', 'description' => 'Tipo (community|nucleo)'],
                ['key' => '_apollo_group_visibility', 'type' => 'string', 'description' => 'Visibilidade (public|private)'],
                ['key' => '_apollo_group_members', 'type' => 'array', 'description' => 'IDs dos membros'],
                ['key' => '_apollo_group_admins', 'type' => 'array', 'description' => 'IDs dos admins'],
            ],
        ];
    }
}
