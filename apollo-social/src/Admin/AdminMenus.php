...
final class AdminMenus {
	...
	public static function addMenus(): void {
		add_menu_page( 'Apollo Social', 'Apollo Social', 'manage_options', 'apollo-social', array( self::class, 'dashboardPage' ), 'dashicons-groups', 30 );
		add_submenu_page( 'apollo-social', 'Dashboard', 'Dashboard', 'manage_options', 'apollo-social', array( self::class, 'dashboardPage' ) );
		add_submenu_page( 'apollo-social', 'Members', 'Members', 'manage_options', 'apollo-members', array( self::class, 'membersPage' ) );
		add_submenu_page( 'apollo-social', 'Pending Users', 'Pending Users', 'manage_options', 'apollo-pending-users', array( self::class, 'pendingUsersPage' ) );
		add_submenu_page( 'apollo-social', 'Spammers', 'Spammers', 'manage_options', 'apollo-spammers', array( self::class, 'spammersPage' ) );
		add_submenu_page( 'apollo-social', 'Verified Users', 'Verified Users', 'manage_options', 'apollo-verified', array( self::class, 'verifiedUsersPage' ) );
		add_submenu_page( 'apollo-social', 'Member Types', 'Member Types', 'manage_options', 'apollo-member-types', array( self::class, 'memberTypesPage' ) );
		add_submenu_page( 'apollo-social', 'Groups', 'Groups', 'manage_options', 'apollo-groups', array( self::class, 'groupsPage' ) );
		add_submenu_page( 'apollo-social', 'Activity', 'Activity', 'manage_options', 'apollo-activity', array( self::class, 'activityPage' ) );
		add_submenu_page( 'apollo-social', 'Points & Ranks', 'Points & Ranks', 'manage_options', 'apollo-gamification', array( self::class, 'gamificationPage' ) );
		add_submenu_page( 'apollo-social', 'Achievements', 'Achievements', 'manage_options', 'apollo-achievements', array( self::class, 'achievementsPage' ) );
		add_submenu_page( 'apollo-social', 'Competitions', 'Competitions', 'manage_options', 'apollo-competitions', array( self::class, 'competitionsPage' ) );
		add_submenu_page( 'apollo-social', 'Notices', 'Notices', 'manage_options', 'apollo-notices', array( self::class, 'noticesPage' ) );
		add_submenu_page( 'apollo-social', 'Profile Fields', 'Profile Fields', 'manage_options', 'apollo-profile-fields', array( self::class, 'profileFieldsPage' ) );
		add_submenu_page( 'apollo-social', 'Email Queue', 'Email Queue', 'manage_options', 'apollo-email-queue', array( self::class, 'emailQueuePage' ) );
		add_submenu_page( 'apollo-social', 'Team Members', 'Team Members', 'manage_options', 'apollo-team', array( self::class, 'teamPage' ) );
		add_submenu_page( 'apollo-social', 'Map Pins', 'Map Pins', 'manage_options', 'apollo-map', array( self::class, 'mapPage' ) );
		add_submenu_page( 'apollo-social', 'Testimonials', 'Testimonials', 'manage_options', 'apollo-testimonials', array( self::class, 'testimonialsPage' ) );
		add_submenu_page( 'apollo-social', 'Settings', 'Settings', 'manage_options', 'apollo-settings', array( self::class, 'settingsPage' ) );
	}
	...
	public static function membersPage(): void {
		...
		$total   = \Apollo\Modules\Members\MembersDirectoryRepository::count( array( 'search' => $search ) );
	...
	public static function memberTypesPage(): void {
		echo '<div class="wrap"><h1>Member Types</h1><p>Configure member types.</p></div>';}
	public static function groupsPage(): void {
		echo '<div class="wrap"><h1>Groups</h1><p>Manage groups.</p></div>';}
	public static function activityPage(): void {
		echo '<div class="wrap"><h1>Activity</h1><p>Monitor activity streams.</p></div>';}
	public static function gamificationPage(): void {
		echo '<div class="wrap"><h1>Points & Ranks</h1><p>Configure gamification.</p></div>';}
	public static function achievementsPage(): void {
		echo '<div class="wrap"><h1>Achievements</h1><p>Manage achievements.</p></div>';}
	public static function competitionsPage(): void {
		echo '<div class="wrap"><h1>Competitions</h1><p>Manage competitions.</p></div>';}
	public static function noticesPage(): void {
		echo '<div class="wrap"><h1>Notices</h1><p>Manage sitewide notices.</p></div>';}
	public static function profileFieldsPage(): void {
		echo '<div class="wrap"><h1>Profile Fields</h1><p>Configure extended profile fields.</p></div>';}
	public static function emailQueuePage(): void {
		echo '<div class="wrap"><h1>Email Queue</h1><p>Monitor email queue.</p></div>';}
	public static function teamPage(): void {
		echo '<div class="wrap"><h1>Team Members</h1><p>Manage team members.</p></div>';}
	public static function mapPage(): void {
		echo '<div class="wrap"><h1>Map Pins</h1><p>Manage map locations.</p></div>';}
	public static function testimonialsPage(): void {
		echo '<div class="wrap"><h1>Testimonials</h1><p>Manage testimonials.</p></div>';}
	public static function settingsPage(): void {
		echo '<div class="wrap"><h1>Settings</h1><p>Apollo Social settings.</p></div>';}
}
