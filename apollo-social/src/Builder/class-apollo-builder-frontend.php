	...
	private static function enqueue_builder_assets() {
		...
		wp_localize_script(
			...
			array(
				...
				'themes'        => class_exists( 'Apollo_Builder_Themes' ) ? Apollo_Builder_Themes::get_themes_for_js() : array(),
				'currentLayout' => Apollo_Home_CPT::get_layout( $post->ID ),
				'currentBg'     => get_post_meta( $post->ID, APOLLO_BUILDER_META_BACKGROUND, true ),
				'currentTheme'  => class_exists( 'Apollo_Builder_Themes' ) ? Apollo_Builder_Themes::get_post_theme( $post->ID ) : '',
				...
				'i18n'          => array(
					...
					'themes'         => __( 'Themes', 'apollo-social' ),
