...
class ApolloLogger {
	...
	private static function tableExists(): bool {
		...
		// Use SHOW TABLES to avoid the FULL COLUMNS error
	...
	public static function log( string $level, string $event, array $context = array(), string $category = 'general' ) {
		...
		// Also log to PHP error_log if debug enabled (do this first regardless of table state)
		...
		// Skip database insert if table doesn't exist (prevents DB errors)
		if ( ! self::tableExists() ) {
			return false;
		}
