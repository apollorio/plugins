...
final class SocialSchema {
	...
	public static function uninstall(): void {
		...
		$tables = array(
			'apollo_user_tags',
			'apollo_user_tag_relations',
			'apollo_profile_fields',
			'apollo_profile_field_groups',
			'apollo_profile_field_values',
			'apollo_profile_tabs',
			'apollo_connections',
			...
			'apollo_competitions',
			'apollo_competition_participants',
			'apollo_activity',
			'apollo_mentions',
			'apollo_favorites',
			'apollo_notices',
			'apollo_user_notices',
			'apollo_content_restrictions',
			'apollo_user_roles',
			'apollo_email_queue',
			'apollo_testimonials',
			'apollo_team_members',
			'apollo_map_pins',
			'apollo_media_offload',
			'apollo_forum_topics',
			'apollo_forum_replies',
			'apollo_user_settings',
			'apollo_spammer_list',
			'apollo_pending_users',
			'apollo_groups',
			'apollo_group_members',
			'apollo_group_meta',
			'apollo_group_types',
			'apollo_group_invites',
			'apollo_member_types',
			'apollo_badges',
			'apollo_user_badges',
			'apollo_reports',
			'apollo_message_threads',
			'apollo_messages',
			'apollo_message_participants',
			'apollo_invitations',
			'apollo_activity_comments',
			'apollo_activity_likes',
		);
		foreach ( $tables as $t ) {
	...
	private static function createUserTagsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_user_tags';
	...
	private static function createUserTagRelationsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_user_tag_relations';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createProfileFieldsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_profile_fields';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createProfileFieldGroupsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_profile_field_groups';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createProfileFieldValuesTable(): void {
		global $wpdb;
	...
	private static function createProfileTabsTable(): void {
		global $wpdb;
	...
	private static function createConnectionsTable(): void {
		global $wpdb;
	...
	private static function createCloseFriendsTable(): void {
		global $wpdb;
	...
	private static function createOnlineUsersTable(): void {
		global $wpdb;
	...
	private static function createPointsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_points';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createPointsLogTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_points_log';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createRanksTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_ranks';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createAchievementsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_achievements';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createUserAchievementsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_user_achievements';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createCompetitionsTable(): void {
		global $wpdb;
	...
	private static function createCompetitionParticipantsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_competition_participants';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createActivityTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_activity';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createMentionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_mentions';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createFavoritesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_favorites';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createNoticesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_notices';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createUserNoticesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_user_notices';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createContentRestrictionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_content_restrictions';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createUserRolesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_user_roles';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createEmailQueueTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_email_queue';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createTestimonialsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_testimonials';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createTeamMembersTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_team_members';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createMapPinsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_map_pins';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			title varchar(255) NOT NULL,
	...
	private static function createMediaOffloadTable(): void {
		global $wpdb;
	...
	private static function createForumTopicsTable(): void {
		global $wpdb;
	...
	private static function createForumRepliesTable(): void {
		global $wpdb;
	...
	private static function createUserSettingsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_user_settings';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createSpammerListTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_spammer_list';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createPendingUsersTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_pending_users';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createGroupsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_groups';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(255) NOT NULL,
	...
	private static function createGroupMembersTable(): void {
		global $wpdb;
	...
	private static function createGroupMetaTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_group_meta';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
	...
	private static function createGroupTypesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_group_types';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createGroupInvitesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_group_invites';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			group_id bigint(20) unsigned NOT NULL,
	...
	private static function createMemberTypesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_member_types';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createBadgesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_badges';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			name varchar(100) NOT NULL,
	...
	private static function createUserBadgesTable(): void {
		global $wpdb;
	...
	private static function createMessageThreadsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_message_threads';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createMessagesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_messages';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createMessageParticipantsTable(): void {
		global $wpdb;
	...
	private static function createInvitationsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_invitations';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			inviter_id bigint(20) unsigned NOT NULL,
	...
	private static function createActivityCommentsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_activity_comments';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			activity_id bigint(20) unsigned NOT NULL,
	...
	private static function createActivityLikesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_activity_likes';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			activity_id bigint(20) unsigned NOT NULL,
