...
final class ExtendedSchema {
	...
	private static function createBookmarksTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_bookmarks';
	...
	private static function createBookmarkCollectionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_bookmark_collections';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createPollOptionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_poll_options';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createPollVotesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_poll_votes';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			poll_id bigint(20) unsigned NOT NULL,
	...
	private static function createStoryViewsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_story_views';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createStoryRepliesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_story_replies';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			story_id bigint(20) unsigned NOT NULL,
	...
	private static function createHashtagUsageTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_hashtag_usage';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createReactionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_reactions';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createModerationQueueTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_moderation_queue';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createModerationActionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_moderation_actions';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createModerationRulesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_moderation_rules';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createProfileViewsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_profile_views';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createAuditLogsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_audit_logs';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned DEFAULT 0,
	...
	private static function createReferralsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_referrals';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createReferralRewardsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_referral_rewards';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createDataExportsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_data_exports';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function create2faSessionsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_2fa_sessions';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function create2faBackupCodesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_2fa_backup_codes';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function create2faTrustedDevicesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_2fa_trusted_devices';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			user_id bigint(20) unsigned NOT NULL,
