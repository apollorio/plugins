...
final class EventsSchema {
	...
	public static function uninstall(): void {
		...
		$tables = array(
			'apollo_events',
			'apollo_event_attendees',
			'apollo_event_interested',
			'apollo_event_categories',
			'apollo_event_meta',
			'apollo_event_reminders',
			'apollo_event_tickets',
			'apollo_event_ticket_orders',
		);
		foreach ( $tables as $t ) {
	...
	private static function createEventAttendeesTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_event_attendees';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createEventInterestedTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_event_interested';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			event_id bigint(20) unsigned NOT NULL,
	...
	private static function createEventMetaTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_event_meta';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
	...
	private static function createEventRemindersTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_event_reminders';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			event_id bigint(20) unsigned NOT NULL,
	...
	private static function createEventTicketsTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_event_tickets';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			event_id bigint(20) unsigned NOT NULL,
	...
	private static function createEventTicketOrdersTable(): void {
		global $wpdb;
		$t   = $wpdb->prefix . 'apollo_event_ticket_orders';
		$c   = $wpdb->get_charset_collate();
		$sql = "CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			event_id bigint(20) unsigned NOT NULL,
