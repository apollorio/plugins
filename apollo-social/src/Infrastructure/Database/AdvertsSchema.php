...
final class AdvertsSchema {
	...
	public static function uninstall(): void {
		global $wpdb;
		$tables=['apollo_adverts','apollo_advert_images','apollo_advert_categories',
			'apollo_advert_favorites','apollo_advert_views','apollo_advert_messages','apollo_advert_reports'];
		foreach($tables as $t){$wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}{$t}");}
	}

	private static function createAdvertsTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_adverts';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
	...
	private static function createAdvertImagesTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_advert_images';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createAdvertCategoriesTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_advert_categories';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	private static function createAdvertFavoritesTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_advert_favorites';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			advert_id bigint(20) unsigned NOT NULL,
			user_id bigint(20) unsigned NOT NULL,
	...
	private static function createAdvertViewsTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_advert_views';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			advert_id bigint(20) unsigned NOT NULL,
	...
	private static function createAdvertMessagesTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_advert_messages';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			advert_id bigint(20) unsigned NOT NULL,
	...
	private static function createAdvertReportsTable(): void {
		global $wpdb;
		$t=$wpdb->prefix.'apollo_advert_reports';$c=$wpdb->get_charset_collate();
		$sql="CREATE TABLE {$t} (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			advert_id bigint(20) unsigned NOT NULL,
