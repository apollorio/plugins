...
class WidgetRegistry
{
    ...
    {
        $this->registerWidget('profile-header', [
        ...
        $this->registerWidget('depoimentos', [
            'name' => 'Depoimentos',
            'icon' => 'message-circle',
            'category' => 'social',
            ...
            'config_fields' => [
                ...
                'allow_comments' => ['type' => 'checkbox', 'label' => 'Permitir Comentários'],
                'max_comments' => ['type' => 'number', 'label' => 'Máximo de Comentários'],
            ]
        ]);

        $this->registerWidget('bio', [
            'name' => 'Biografia',
            'icon' => 'file-text',
            'category' => 'content',
        ...
        $this->registerWidget('sign-document', [
    ...
    {
        $this->widgets[$type] = wp_parse_args($config, [
            'name' => ucfirst($type),
            'icon' => 'square',
            'category' => 'general',
            'default_size' => ['w' => 6, 'h' => 4],
