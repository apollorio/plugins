...
class Caps
{
    ...
    private function assignAdministratorCapabilities(): void
    {
        ...
        $capabilities = [
            // Groups - Full access
            'read_apollo_group', 'read_private_apollo_groups', 'create_apollo_groups',
            'edit_apollo_groups', 'edit_others_apollo_groups', 'edit_private_apollo_groups',
            'publish_apollo_groups', 'delete_apollo_groups', 'delete_others_apollo_groups',
            'delete_private_apollo_groups', 'manage_apollo_group_members', 'moderate_apollo_group_content',
            
            // Events - Full access
            'read_eva_event', 'read_private_eva_events', 'create_eva_events',
            'edit_eva_events', 'edit_others_eva_events', 'edit_private_eva_events',
            'publish_eva_events', 'delete_eva_events', 'delete_others_eva_events',
            'delete_private_eva_events', 'manage_eva_event_categories', 'manage_eva_event_locations',
            
            // Ads - Full access
            'read_apollo_ad', 'read_private_apollo_ads', 'create_apollo_ads',
            'edit_apollo_ads', 'edit_others_apollo_ads', 'edit_private_apollo_ads',
            'publish_apollo_ads', 'delete_apollo_ads', 'delete_others_apollo_ads',
            'delete_private_apollo_ads', 'moderate_apollo_ads',
            
            // Moderation - Full access
            'apollo_moderate', 'apollo_moderate_groups', 'apollo_moderate_events',
            'apollo_moderate_ads', 'apollo_moderate_users', 'apollo_moderate_all',
            'apollo_view_moderation_queue', 'apollo_manage_moderators',
    ...
    private function assignEditorCapabilities(): void
    {
        ...
        $capabilities = [
            ...
            'apollo_moderate', 'apollo_moderate_groups', 'apollo_moderate_events',
            'apollo_moderate_ads', 'apollo_view_moderation_queue',
            
            // Analytics - View and manage
            'apollo_view_analytics', 'apollo_manage_analytics'
        ];
    ...
    private function assignAuthorCapabilities(): void
    {
        ...
        $capabilities = [
            ...
            'read_apollo_group', 'create_apollo_groups', 'edit_apollo_groups', 'delete_apollo_groups',
            
            // Events - Can publish directly!
            'read_eva_event', 'create_eva_events', 'edit_eva_events', 'delete_eva_events', 'publish_eva_events',
            
            // Ads - Create own, edit own, requires approval
            'read_apollo_ad', 'create_apollo_ads', 'edit_apollo_ads', 'delete_apollo_ads',
    ...
    private function assignContributorCapabilities(): void
    {
        ...
        $capabilities = [
            ...
            'read_apollo_group', 'create_apollo_groups', 'edit_apollo_groups',
            
            // Events - Create, edit own drafts, NO publish, NO delete published
            'read_eva_event', 'create_eva_events', 'edit_eva_events',
            
            // Ads - Create, edit own drafts, NO publish, NO delete published
            'read_apollo_ad', 'create_apollo_ads', 'edit_apollo_ads',
    ...
    private function assignSubscriberCapabilities(): void
    {
        ...
        $capabilities = [
            ...
            'read_apollo_group', 'create_apollo_groups',
            
            // Events - Can create but NO publish (pending only)
            'read_eva_event', 'create_eva_events',
            
            // Ads - Can create AND publish (published directly)
            'read_apollo_ad', 'create_apollo_ads', 'publish_apollo_ads',
        ];
