...
class Caps {
	...
	private function assignContributorCapabilities(): void {
		...
		$capabilities = array(
			// Groups - Create, edit own drafts
			'read_apollo_group',
			'create_apollo_groups',
			'edit_apollo_groups',
			'delete_apollo_groups',

			// Events - Create, edit own drafts
			'read_eva_event',
			'create_eva_events',
			'edit_eva_events',
			'delete_eva_events',

			// Ads - Create, edit own drafts
			'read_apollo_ad',
			'create_apollo_ads',
			'edit_apollo_ads',
			'delete_apollo_ads',

			// DJs - Create, edit own drafts
			'read_dj_profile',
			'create_dj_profiles',
			'edit_dj_profiles',
			'delete_dj_profiles',

			// Venues - Create, edit own drafts
			'read_local',
			'create_locals',
			'edit_locals',
			'delete_locals',

			// Documents - Create, edit own drafts
			'read_document',
			'create_documents',
			'edit_documents',
			'delete_documents',

			// Classifieds - Create, edit own drafts
			'read_classified',
			'create_classifieds',
			'edit_classifieds',
			'delete_classifieds',
	...
	/**
	 * Subscriber capabilities - Read only for all content types
	 */
