...
class SocialPostType
{
    ...
    public function registerPostType(): void
    {
        ...
        $args = [
            ...
            'comment_status'     => 'open', // FASE 2: Permitir comentários
            'map_meta_cap'       => true,
            'capabilities'       => [
                'create_posts' => 'publish_posts', // Apenas usuários que podem publicar podem criar
            ],
        ];
    ...
    private function registerTaxonomy(): void
    {
        ...
        register_taxonomy('apollo_post_category', ['apollo_social_post'], [
            'hierarchical'      => true,
            'labels'            => $labels,
            'show_ui'           => true,
