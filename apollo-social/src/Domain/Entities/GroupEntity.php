...
class GroupEntity
{
    ...
    public $creator_id;
    public $created_by; // Legacy alias
    public $created_at;
    public $updated_at;
    public $published_at;
    ...
    public function __construct($data = [])
    {
        ...
        $this->created_by = $this->creator_id; // Legacy alias
    ...
    public function getSeasonSlug(): ?string { return $this->season_slug; }
    public function getCreatorId(): int { return (int) $this->creator_id; }
    public function getCreatedAt(): string { return $this->created_at; }
    public function getUpdatedAt(): ?string { return $this->updated_at; }
    public function getPublishedAt(): ?string { return $this->published_at; }
    public function getMembersCount(): int { return (int) $this->members_count; }
