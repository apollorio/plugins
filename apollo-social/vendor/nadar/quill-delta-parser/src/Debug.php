...
class Debug {
	...
	public function getLinesTable( array $lines ) {
		...
		return $this->renderTable( $_lines, array( 'ID', 'input', 'output', 'prepend', 'debug', 'attributes', 'is inline', 'status', 'has end newline', 'has new line', 'is empty' ) );
	}
	 ...
	 * @return string
	 */
	protected function renderTable( array $rows, array $head = array() ) {
