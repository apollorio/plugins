...
class Size extends PrimitiveValue {
	 ...
	 * @internal
	 */
	const ABSOLUTE_SIZE_UNITS = array(
		'px',
		'pt',
		'pc',
		'cm',
	 ...
	 * @internal
	 */
	const RELATIVE_SIZE_UNITS = array( '%', 'em', 'ex', 'ch', 'fr' );
	 ...
	 * @internal
	 */
	const NON_SIZE_UNITS = array( 'deg', 'grad', 'rad', 's', 'ms', 'turn', 'Hz', 'kHz' );
	...
	public function render( $oOutputFormat ) {
		...
		return preg_replace( array( "/$sPoint/", '/^(-?)0\./' ), array( '.', '$1.' ), $sSize )
