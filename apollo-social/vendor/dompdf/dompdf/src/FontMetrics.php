...
class FontMetrics {
	...
	public function getFont( $familyRaw, $subtypeRaw = 'normal' ) {
		...
		$fallback_families = array( strtolower( $this->options->getDefaultFont() ), 'serif' );
