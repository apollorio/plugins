...
interface Canvas {
	 ...
	 */
	function line( $x1, $y1, $x2, $y2, $color, $width, $style = array(), $cap = 'butt' );
	 ...
	 * @param string $cap   `butt`, `round`, or `square`
	 */
	function arc( $x, $y, $r1, $r2, $astart, $aend, $color, $width, $style = array(), $cap = 'butt' );
	 ...
	 * @param string $cap   `butt`, `round`, or `square`
	 */
	function rectangle( $x1, $y1, $w, $h, $color, $width, $style = array(), $cap = 'butt' );
	 ...
	 */
	function circle( $x, $y, $r, $color, $width = null, $style = array(), $fill = false );
