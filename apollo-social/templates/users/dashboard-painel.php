...
// Render dashboard
apollo_render_dashboard_page( array(
    'title'       => 'Meu Painel',
    'breadcrumbs' => array(
        array( 'label' => 'Início', 'url' => home_url( '/' ) ),
        array( 'label' => 'Meu Painel', 'url' => '' ),
    ),
    'cards'       => array(
        array(
            'title'       => 'Eventos Criados',
            'value'       => count( $tabs['my_events']['data'] ?? array() ),
        ...
        array(
            'title'       => 'Favoritos',
            'value'       => count( $tabs['events']['data'] ?? array() ),
        ...
        array(
            'title'       => 'Comunidades',
            'value'       => count( $tabs['communities']['data'] ?? array() ),
            'description' => 'grupos ativos',
            'badge'       => count( $tabs['nucleo']['data'] ?? array() ) . ' núcleos',
            'tooltip'     => __( 'Comunidades e grupos dos quais você faz parte. Núcleos são grupos privados', 'apollo-social' ),
            'icon'        => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',
        ),
        array(
            'title'       => 'Documentos',
            'value'       => count( $tabs['docs']['data'] ?? array() ),
            'description' => 'para assinar',
            'trend'       => null,
            'footer'      => 'Última atividade: agora',
            'tooltip'     => __( 'Contratos e documentos que requerem sua assinatura ou revisão', 'apollo-social' ),
    ...
    'chart'       => array(
        ...
        'data'  => array(), // Add chart data here
    ),
    'table'       => array(
        'title'       => 'Eventos Favoritos',
        'description' => 'Eventos que você marcou para acompanhar',
        'columns'     => array(
            array( 'key' => 'title', 'label' => 'Evento' ),
            array( 'key' => 'date', 'label' => 'Data' ),
            array( 
                'key'    => 'status', 
                'label'  => 'Status',
