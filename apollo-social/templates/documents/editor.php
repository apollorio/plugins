...
<head>
	...
	<style>
		:root {
			--apollo-primary: var(--ap-primary, #3498db);
			--apollo-bg: var(--ap-bg-muted, #f0f2f5);
			--paper-width: 210mm;
			--paper-height: 297mm;
			--toolbar-height: 70px;
		}
...
<body>
	...
	<div class="apollo-navbar">
		...
		<div class="navbar-actions">
			...
			<button class="btn-navbar" id="btn-save"
					data-ap-tooltip="<?php esc_attr_e( 'Salvar documento (Ctrl+S)', 'apollo-social' ); ?>">
				<span class="material-symbols-rounded">save</span>
				<span><?php esc_html_e( 'Salvar', 'apollo-social' ); ?></span>
			</button>
			<?php endif; ?>
	...
	<div class="editor-toolbar">
		...
		<div class="tool-group">
			<select id="fontSelector" class="form-select-sm"
				...
				<option value="Roboto", Roboto selected>Urbanist</option>
	...
	(function() {
		...
		function prepareForSigning() {
			...
			alert('<?php echo esc_js( __( 'Salve o documento antes de assinar.', 'apollo-social' ) ); ?>');
			}
