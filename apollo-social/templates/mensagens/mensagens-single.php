...
<head>
	...
	<style>
		...
		═══════════════════════════════════════════════════════════════════════ */
		:root {
			--chat-bg: var(--ap-bg-muted, #fafafa);
			--chat-card: var(--ap-bg, #ffffff);
			--chat-border: var(--ap-border, #e5e7eb);
			--chat-primary: var(--ap-text-dark, #18181b);
			--chat-primary-fg: var(--ap-bg-muted, #fafafa);
			--chat-muted: var(--ap-bg-muted, #f4f4f5);
			--chat-muted-fg: var(--ap-text-muted, #71717a);
			--chat-radius: var(--ap-radius-lg, 0.75rem);
			--apollo-viewport-height: 100vh;
		}

		.dark {
			--chat-bg: var(--ap-bg-dark, #09090b);
			--chat-card: var(--ap-bg-dark-alt, #18181b);
			--chat-border: var(--ap-border-dark, #27272a);
			--chat-primary: var(--ap-text-light, #fafafa);
			--chat-primary-fg: var(--ap-text-dark, #18181b);
			--chat-muted: var(--ap-bg-dark-alt, #27272a);
			--chat-muted-fg: var(--ap-text-muted-dark, #a1a1aa);
		}
