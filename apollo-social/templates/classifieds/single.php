	...
	<div class="flex-1 flex flex-col min-h-screen">
		...
		<header class="ap-classifieds-header" style="margin-bottom: 0; padding: 16px 0;">
			...
			<div style="display: flex; gap: 8px;">
				...
				<button class="ap-btn-icon-sm" data-ap-tooltip="<?php esc_attr_e( 'Salvar nos favoritos', 'apollo-social' ); ?>" data-action="favorite" data-post-id="<?php echo esc_attr( $classified_id ); ?>">
