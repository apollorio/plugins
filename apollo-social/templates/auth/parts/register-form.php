...
<form id="register-form" method="post" data-tooltip="<?php esc_attr_e( 'Formulário de registro', 'apollo-social' ); ?>">
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Tipo de documento', 'apollo-social' ); ?>">
		...
		<input type="hidden" name="doc_type" id="doc_type" value="cpf" title="Tipo de documento">
	</div>
	...
	<div class="form-group hidden" id="passport-field" data-tooltip="<?php esc_attr_e( 'Campo de Passaporte', 'apollo-social' ); ?>">
		...
		<div class="input-wrapper" style="margin-top: 10px;">
			...
			<input
				...
				title="País de emissão do passaporte"
				autocomplete="off"
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Campo de senha', 'apollo-social' ); ?>">
		...
		<div class="input-wrapper">
			...
			<input
				...
				title="Crie sua chave de acesso"
				minlength="8"
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Seleção de gêneros musicais', 'apollo-social' ); ?>">
		...
		<div class="sounds-chips" style="display: flex; flex-wrap: wrap; gap: 8px;" data-tooltip="<?php esc_attr_e( 'Clique para selecionar', 'apollo-social' ); ?>">
			<?php foreach ( $available_sounds as $slug => $name ) : ?>
				<?php $sound_id = 'sound-' . sanitize_key( $slug ); ?>
				<label class="quiz-chip sound-chip" for="<?php echo esc_attr( $sound_id ); ?>" data-value="<?php echo esc_attr( $slug ); ?>" data-tooltip="<?php echo esc_attr( $name ); ?>">
					<input id="<?php echo esc_attr( $sound_id ); ?>" type="checkbox" name="sounds[]" value="<?php echo esc_attr( $slug ); ?>" title="<?php echo esc_attr( $name ); ?>" style="display: none;">
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Aceite dos termos', 'apollo-social' ); ?>">
		<div class="custom-toggle terms-toggle" title="Aceitar termos" data-tooltip="<?php esc_attr_e( 'Clique para aceitar', 'apollo-social' ); ?>">
	...
	<!-- Submit Button -->
	<button type="submit" class="btn-primary" title="Prosseguir com o registro" data-tooltip="<?php esc_attr_e( 'Prosseguir para o teste de aptidão', 'apollo-social' ); ?>">
...
<div style="text-align: center; margin-top: 20px;" data-tooltip="<?php esc_attr_e( 'Link para login', 'apollo-social' ); ?>">
	<p style="font-size: 12px; color: rgba(148,163,184,0.9);">
		...
		<button type="button" class="btn-text" id="switch-to-login" title="Voltar para login" data-tooltip="<?php esc_attr_e( 'Voltar para login', 'apollo-social' ); ?>">
