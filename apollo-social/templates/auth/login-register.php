...
// Get configuration
$auth_config = apply_filters('apollo_auth_config', [
...
$available_sounds = apply_filters('apollo_registration_sounds', [
    'techno'     => 'Techno',
    'house'      => 'House',
    'trance'     => 'Trance',
    'drum_bass'  => 'Drum & Bass',
...
<body data-state="normal">
    ...
    <div class="terminal-wrapper" data-tooltip="<?php esc_attr_e('Terminal de Autenticação Apollo', 'apollo-social'); ?>">
        ...
        <!-- Lockout Overlay -->
        <?php include __DIR__ . '/parts/lockout-overlay.php'; ?>

        <!-- Aptitude Quiz Overlay -->
        <?php include __DIR__ . '/parts/aptitude-quiz.php'; ?>
