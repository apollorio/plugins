...
function renderPatternQuiz() {
    ...
    els.testContent.innerHTML = `
        <h3 class="text-[16px] font-semibold text-amber-100 mb-2" data-tooltip="Título do teste de padrões">RECONHECIMENTO DE PADRÕES RÍTMICOS</h3>
        <p class="text-[11px] text-slate-400 mb-4 max-w-xs" data-tooltip="Instrução do teste">
            Identifique o próximo padrão de batida na sequência.
        </p>
        <div class="pattern-sequence" data-tooltip="Sequência de padrões musicais">
            <div class="pattern-item" data-tooltip="Padrão 1">♪</div>
            <div class="pattern-item" data-tooltip="Padrão 2">♫</div>
            <div class="pattern-item" data-tooltip="Padrão 3">♪♪</div>
            <div class="pattern-item" data-tooltip="Padrão 4">♫♫</div>
            <div class="pattern-item pattern-question" data-tooltip="Próximo padrão">?</div>
        </div>
        <div class="pattern-options" data-tooltip="Opções de resposta">
            <button class="pattern-option test-option" data-value="♪♪♪" data-correct="true" data-tooltip="Opção ♪♪♪">♪♪♪</button>
            <button class="pattern-option test-option" data-value="♪♪♫" data-tooltip="Opção ♪♪♫">♪♪♫</button>
            <button class="pattern-option test-option" data-value="♫♫♫" data-tooltip="Opção ♫♫♫">♫♫♫</button>
            <button class="pattern-option test-option" data-value="♫♪♫" data-tooltip="Opção ♫♪♫">♫♪♫</button>
        </div>
        <p class="text-[10px] text-slate-500 mt-4 max-w-xs" data-tooltip="Dica do teste">
...
function renderSimonGame() {
    ...
    els.testContent.innerHTML = `
        <h3 class="text-[16px] font-semibold text-amber-100 mb-2" data-tooltip="Título do teste Simon">TESTE DE MEMÓRIA SIMON</h3>
        <p class="text-[11px] text-slate-400 mb-4 max-w-xs" data-tooltip="Instrução do Simon">
            Memorize a sequência de cores. O teste tem 4 níveis.
        </p>
        <div class="text-center mb-4" data-tooltip="Indicador de nível">
            <span class="text-[10px] font-mono px-2 py-1 rounded border border-slate-500/70 text-slate-200">
                NÍVEL: <span id="simon-level" data-tooltip="Nível atual">1</span>/4
            </span>
        </div>
        <div class="simon-container" id="simon-grid" data-tooltip="Grid do jogo Simon">
            <button class="simon-btn simon-red" data-color="red" data-tooltip="Botão vermelho"></button>
            <button class="simon-btn simon-blue" data-color="blue" data-tooltip="Botão azul"></button>
            <button class="simon-btn simon-green" data-color="green" data-tooltip="Botão verde"></button>
            <button class="simon-btn simon-yellow" data-color="yellow" data-tooltip="Botão amarelo"></button>
        </div>
        <p id="simon-status" class="text-[11px] text-amber-300 font-mono mt-4" data-tooltip="Status do Simon">
            Observe a sequência...
        </p>
    `;
...
function renderEthicsQuiz() {
    ...
    els.testContent.innerHTML = `
        <h3 class="text-[16px] font-semibold text-amber-100 mb-2" data-tooltip="Título do teste de ética">TESTE DE ÉTICA E RESPEITO</h3>
        <p class="text-[11px] text-slate-400 mb-4 max-w-xs leading-relaxed" data-tooltip="Pergunta do teste">
            "Não gosto de Eletrônica com Funk / de Tribal / de Techno / de Melódico", logo...
        </p>
        <div class="space-y-2 w-full max-w-xs text-left" data-tooltip="Opções de resposta">
            <button class="test-option w-full p-3 border border-slate-600/80 rounded-md text-[11px] bg-slate-900/70 hover:bg-slate-800/90 transition text-left" data-value="bad1" data-tooltip="Opção incorreta">
                Critico e não me importo com quem trabalha com isso.
            </button>
            <button class="test-option w-full p-3 border border-slate-600/80 rounded-md text-[11px] bg-slate-900/70 hover:bg-slate-800/90 transition text-left" data-value="bad2" data-tooltip="Opção incorreta">
                A depender da lua, posso falar mal e pesar a mão sobre.
            </button>
            <button class="test-option w-full p-3 border border-slate-600/80 rounded-md text-[11px] bg-slate-900/70 hover:bg-slate-800/90 transition text-left" data-value="good" data-correct="true" data-tooltip="Opção correta - Respeito">
                É trabalho, renda, a sonoridade e arte favorita de alguém. Respeito.
            </button>
            <button class="test-option w-full p-3 border border-slate-600/80 rounded-md text-[11px] bg-slate-900/70 hover:bg-slate-800/90 transition text-left" data-value="bad3" data-tooltip="Opção incorreta">
                Tenho dúvidas, mas falo mal e deixo arder mesmo assim.
            </button>
        </div>
        <p class="text-[10px] text-slate-500 mt-4 max-w-xs" data-tooltip="Nota sobre comunidade">
...
function renderReactionTest() {
    ...
    els.testContent.innerHTML = `
        <h3 class="text-[16px] font-semibold text-amber-100 mb-2" data-tooltip="Título do teste de reação">TESTE DE REAÇÃO & SINCRONIA</h3>
        <p class="text-[11px] text-slate-400 mb-4 max-w-xs" data-tooltip="Instrução do teste">
            Toque nos ícones de som piscando antes que desapareçam.
        </p>
        <div class="reaction-arena" id="reaction-arena" data-tooltip="Área do teste de reação">
            <div class="capture-counter" data-tooltip="Contador de capturas">CAPTURAS: <span id="reaction-score">0</span>/4</div>
        </div>
        <p id="reaction-status" class="text-[11px] text-amber-300 font-mono mt-4" data-tooltip="Status do teste">
            Aguarde os ícones aparecerem...
        </p>
    `;
