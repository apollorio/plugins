                        ...
                        <tr>
                            ...
                            ?>
                                <th 
                                    ...
                                    <?php if ( $is_sortable ) : ?>data-sortable="true"<?php endif; ?>
                                >
...
function apollo_render_table_badge( $status, array $variants = array() ) {
    $defaults = array(
        'publish'   => array( 'label' => 'Publicado', 'class' => 'bg-emerald-100 text-emerald-700' ),
        'draft'     => array( 'label' => 'Rascunho', 'class' => 'bg-slate-100 text-slate-700' ),
        'pending'   => array( 'label' => 'Pendente', 'class' => 'bg-amber-100 text-amber-700' ),
        'signed'    => array( 'label' => 'Assinado', 'class' => 'bg-emerald-100 text-emerald-700' ),
        'active'    => array( 'label' => 'Ativo', 'class' => 'bg-emerald-100 text-emerald-700' ),
        'inactive'  => array( 'label' => 'Inativo', 'class' => 'bg-slate-100 text-slate-700' ),
    );
    $variants = wp_parse_args( $variants, $defaults );

    $variant = $variants[ $status ] ?? array( 'label' => ucfirst( $status ), 'class' => 'bg-slate-100 text-slate-700' );
