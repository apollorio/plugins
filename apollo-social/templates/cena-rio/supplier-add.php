...
// Enqueue assets via CDN loader.
add_action(
	'wp_enqueue_scripts',
	function () {
		// CDN loader script auto-loads all needed styles (index.css, icons, dark-mode, etc.)
...
<head>
	...
	<style>
	:root {
		--ap-font-primary: var(--ap-font-sans, "Roboto", Roboto, system-ui, -apple-system, sans-serif);
		--ap-bg-main: var(--ap-bg, #ffffff);
		--ap-bg-surface: var(--ap-bg-muted, #f8fafc);
		--nav-height: 70px;
	}
...
<body class="apollo-canvas">
	...
	<nav class="navbar">
		...
		<div class="flex items-center gap-2">
			<div class="clock-pill hidden sm:block px-4 py-2 text-xs font-semibold text-slate-500" id="digital-clock">
			</div>
		</div>
	</nav>
		...
		<form method="post" enctype="multipart/form-data" class="form-card">
			...
			<div class="form-section">
				...
				<div class="form-group">
					...
					<input type="text" id="name" name="name" class="form-input" placeholder="Ex: Studio Foto Premium"
						required
				...
				<div class="form-group">
					...
					<textarea id="description" name="description" class="form-textarea"
						placeholder="Descreva os serviços oferecidos..."><?php echo isset( $_POST['description'] ) ? esc_textarea( wp_unslash( $_POST['description'] ) ) : ''; ?></textarea>
				...
				<div class="form-grid">
					<div class="form-group">
						...
						<select id="category" name="category" class="form-select" required>
							...
							<option value="<?php echo esc_attr( $slug ); ?>"
								<?php selected( isset( $_POST['category'] ) && sanitize_key( wp_unslash( $_POST['category'] ) ) === $slug ); ?>>
					...
					<div class="form-group">
						...
						<select id="region" name="region" class="form-select">
							...
							<option value="<?php echo esc_attr( $slug ); ?>"
								<?php selected( isset( $_POST['region'] ) && sanitize_key( wp_unslash( $_POST['region'] ) ) === $slug ); ?>>
								<?php echo esc_html( $label ); ?>
							</option>
							<?php endforeach; ?>
						</select>
				...
				<div class="form-group">
					...
					<select id="neighborhood" name="neighborhood" class="form-select">
						...
						<option value="<?php echo esc_attr( $slug ); ?>"
							<?php selected( isset( $_POST['neighborhood'] ) && sanitize_key( wp_unslash( $_POST['neighborhood'] ) ) === $slug ); ?>>
							<?php echo esc_html( $label ); ?>
						</option>
						<?php endforeach; ?>
					</select>
				...
				<div class="form-grid">
					<div class="form-group">
						...
						<select id="type" name="type" class="form-select">
							...
							<option value="<?php echo esc_attr( $slug ); ?>"
								<?php selected( isset( $_POST['type'] ) && sanitize_key( wp_unslash( $_POST['type'] ) ) === $slug ); ?>>
								<?php echo esc_html( $label ); ?>
							</option>
							<?php endforeach; ?>
						</select>
					...
					<div class="form-group">
						...
						<select id="mode" name="mode" class="form-select">
							...
							<option value="<?php echo esc_attr( $slug ); ?>"
								<?php selected( isset( $_POST['mode'] ) && sanitize_key( wp_unslash( $_POST['mode'] ) ) === $slug ); ?>>
								<?php echo esc_html( $label ); ?>
							</option>
							<?php endforeach; ?>
						</select>
			...
			<div class="form-section">
				...
				<div class="form-grid">
					<div class="form-group">
						...
						<input type="text" id="contact_whatsapp" name="contact_whatsapp" class="form-input"
				...
				<div class="form-group">
					...
					<input type="url" id="contact_website" name="contact_website" class="form-input"
