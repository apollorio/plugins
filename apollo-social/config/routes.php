...
return array(
	...
	'/mural/'            => array(
		'pattern'        => '^mural/?$',
		'query_vars'     => array( 'apollo_route' => 'mural' ),
	...
	// Mensagens (anteriormente /chat/)
	'/chat/'             => array(
		'pattern'    => '^chat/?$',
		'query_vars' => array( 'apollo_route' => 'mensagens' ),
		'template'   => 'mensagens/mensagens.php',
		'handler'    => 'Apollo\\Infrastructure\\Rendering\\RawTemplateRenderer',
		'canvas'     => true,
		'raw_html'   => true,
		'fullscreen' => true,
	...
	// Mensagens - Conversa Individual (anteriormente /chat/{userID})
	'/chat/{userID}'     => array(
		'pattern'    => '^chat/([0-9]+)/?$',
		'query_vars' => array(
			'apollo_route' => 'mensagens_user',
			'user_id'      => '$matches[1]',
		),
		'template'   => 'mensagens/mensagens-single.php',
		'handler'    => 'Apollo\\Infrastructure\\Rendering\\RawTemplateRenderer',
		'canvas'     => true,
		'raw_html'   => true,
		'fullscreen' => true,
	...
	'/mapa/'             => array(
		'pattern'     => '^mapa/?$',
		'query_vars'  => array( 'apollo_route' => 'mapa' ),
		'template'    => 'mapa/mapa.php',
		'handler'     => 'Apollo\\Infrastructure\\Rendering\\RawTemplateRenderer',
		'canvas'      => true,
		'raw_html'    => true,
		'description' => 'Mapa interativo de usuários e locais',
		'assets'      => array(
			'css' => array(
				'apollo-mapa' => array(
					'src'     => APOLLO_SOCIAL_PLUGIN_URL . 'assets/css/mapa.css',
					'deps'    => array( 'apollo-canvas-mode' ),
					'version' => APOLLO_SOCIAL_VERSION,
				),
			),
			'js'  => array(
				'apollo-mapa' => array(
					'src'     => APOLLO_SOCIAL_PLUGIN_URL . 'assets/js/mapa.js',
					'deps'    => array( 'apollo-canvas' ),
					'version' => APOLLO_SOCIAL_VERSION,
				),
			),
