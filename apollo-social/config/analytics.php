...
return [
    ...
    */
    'plausible' => [
        ...
        'script_url' => 'https://plausible.io/js/script.js', // Or self-hosted
        'inject_on_canvas' => true, // Only inject on Apollo Canvas routes
        'custom_events' => true, // Enable custom events tracking
        'outbound_links' => true, // Track outbound clicks
        'file_downloads' => false, // Track file downloads
    ],
    ...
    */
    'statistics_panel' => [
        ...
        'show_plausible_embed' => false, // Set to true if you have public dashboard
