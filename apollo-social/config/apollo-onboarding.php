...
return [
    ...
    'flow' => [
        ...
        'max_attempts' => 3,
        'session_timeout' => 30 * MINUTE_IN_SECONDS, // 30 minutes
    ...
    'verification' => [
        ...
        'required' => true,
        'auto_approve' => false,
        'review_timeout' => 24 * HOUR_IN_SECONDS, // 24 hours
    ...
    'security' => [
        'rate_limiting' => [
            ...
            'onboarding_start' => [
                'requests' => 3,
                'window' => 10 * MINUTE_IN_SECONDS // 10 minutes
            ],
            'onboarding_complete' => [
                'requests' => 1,
        ...
        'data_protection' => [
            'encrypt_sensitive' => false, // Would need encryption key
            'hash_tokens' => false, // Tokens need to be readable
            'anonymize_logs' => true,
            'gdpr_compliant' => true
        ]
    ],
    ...
    'analytics' => [
        ...
        'enable_external' => false, // No external APIs as requested
        'local_storage' => true,
        'retention_days' => 90,
    ...
    'performance' => [
        ...
        'monitoring' => [
            ...
            'memory_limit_warning' => 0.8 // 80% of limit
        ]
    ],
