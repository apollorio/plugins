...
function apollo_create_group_example() {
    ...
    $content_type = 'group';
    $context = ['group_type' => 'comunidade']; // Could be: post, discussion, comunidade, nucleo
    ...
    return [
        ...
        'needs_moderation' => in_array($initial_status, ['pending', 'pending_review'])
    ];
}
...
function apollo_handle_group_creation() {
    ...
    $needs_moderation = in_array($status, ['pending', 'pending_review']);
    if ($needs_moderation) {
        $moderation->submitForReview($group_id, $user->ID, 'group', [
            'title' => $title,
            'type' => $group_type,
...
function apollo_register_workflow_hooks() {
    ...
    add_action('wp_enqueue_scripts', function() {
        ...
        wp_localize_script('apollo-moderation', 'apolloModeration', [
...
function apollo_test_workflow_integration() {
    ...
    $test_cases = [
        ['role' => 'subscriber', 'content_type' => 'group', 'context' => ['group_type' => 'post']],
        ['role' => 'subscriber', 'content_type' => 'group', 'context' => ['group_type' => 'comunidade']],
        ['role' => 'contributor', 'content_type' => 'group', 'context' => ['group_type' => 'post']],
        ['role' => 'author', 'content_type' => 'group', 'context' => ['group_type' => 'comunidade']],
        ['role' => 'editor', 'content_type' => 'group', 'context' => ['group_type' => 'comunidade']],
    ];
