	...
	private function register_content_settings_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::TEXT,
				'description' => sprintf( __( 'Get JSON code URL from %s', 'trx_addons' ), '<a href="https://lottiefiles.com/"' . trx_addons_external_links_target( true ) . '>' . __( 'here', 'trx_addons' ) . '</a>' ),
				'label_block' => true,
				'conditions'  => array(
					'relation' => 'and',
					'terms'    => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}}.trx-addons-nav-hor .trx-addons-nav-menu-container > .trx-addons-nav-menu > .trx-addons-nav-menu-item > .trx-addons-submenu:before' => 'top: -{{TOP}}{{UNIT}}; height: {{TOP}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}}.trx-addons-nav-hor .trx-addons-nav-menu-container > .trx-addons-nav-menu > .trx-addons-nav-menu-item > .trx-addons-mega-content-container:before' => 'top: -{{TOP}}{{UNIT}}; height: {{TOP}}{{UNIT}};',
				),
			)
		);
