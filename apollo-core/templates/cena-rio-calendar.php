...
<head>
	...
	<!-- Map Library - Local -->
	<link rel="stylesheet" href="<?php echo esc_url( $asset_base . 'vendor/leaflet/leaflet.css' ); ?>"
	...
	<style>
		...
		:root {
			...
			/* Calendar Specific */
			--bg-calendar: #f8fafc;
			--muted-calendar: #64748b;
			--accent-calendar: #f97316;
			--accent-strong: #ea580c;
			--confirmed-calendar: #10b981;
			--card-calendar: #ffffff;
			--border-calendar: #e6eef6;
			--shadow-calendar: 0 8px 30px rgba(15,23,42,0.06);
		}
		...
		body.dark-mode {
			...
			/* Calendar Dark Mode */
			--bg-calendar: #1a1d23;
			--card-calendar: #23262f;
			--border-calendar: #374151;
			--shadow-calendar: 0 8px 30px rgba(0,0,0,0.3);
		}
