...
<head>
	...
	<style>
		...
		:root {
			--font-primary: var(--ap-font-sans, 'Instrument Sans', -apple-system, BlinkMacSystemFont, sans-serif);
			--bg-main: var(--ap-bg, #ffffff);
			--bg-surface: var(--ap-bg-muted, #f8f9fa);
			--text-primary: var(--ap-text-dark, #131313);
			--text-secondary: var(--ap-text-muted, #6c757d);
			--border-color: var(--ap-border-light, rgba(0, 0, 0, 0.08));
			--border-color-2: var(--ap-border-medium, rgba(0, 0, 0, 0.2));
			--radius-main: var(--ap-radius-lg, 14px);
