...
$dj_photo_url      = $dj_photo_url ?? $asset_base . 'img/placeholder-dj.webp';
...
<head>
	...
	<style>
		...
		:root {
			...
			--bg-main: #ffffff;
			--bg-surface: #f5f5f5;
			--text-main: rgba(19, 21, 23, 0.6);
			--text-primary: rgba(19, 21, 23, 0.9);
			--text-secondary: rgba(19, 21, 23, 0.6);
			--radius-main: 18px;
			--transition-main: all 0.25s ease;
		}
