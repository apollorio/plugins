...
<head>
  ...
  <style>
    ...
    .is-open { z-index: 8888!important; }
...
<body class="min-h-screen">
  ...
  <!-- APP SHELL: SIDEBAR DESKTOP + MAIN + BOTTOM NAV MOBILE -->
  <div class="min-h-screen flex bg-slate-50">

    <!-- SIDEBAR DESKTOP (nav lateral, mais clean) -->
    ...
    <!-- MAIN COLUMN (TOP HEADER + FEED + SIDEBAR DIREITA) -->
    <div class="flex-1 flex flex-col min-h-screen">

      <!-- TOP HEADER (sempre visível) -->
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex flex-col leading-none">
            <h1 class="text-[15px] font-extrabold mt-2 text-slate-900">
              <span id="user_ID_FEED">Valle, <span id="check-time-for-greetings">boa tarde</span>!</span>
            </h1>
            <p class="text-[12px] text-slate-500">
              @valle
              <span class="text-[10px]" id="membershipds">DJ · Produtor · Promoter</span>
            </p>
          </div>
        </div>
      ...
      <main class="flex-1 flex justify-center px-0 md:px-6 py-0 md:py-6 pb-24 md:pb-6">
        <div class="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-6">
          ...
          <div class="space-y-4">
            ...
            <!-- FEED STREAM -->
            <div id="feed-container" class="space-y-4 px-0 md:px-0">
            ...
            <div class="aprioEXP-card-shell p-4">
              ...
              <div class="space-y-4 text-[12px]">
                  ...
                  <div class="space-y-1">
                    <button class="w-full text-left aprio-mini-list-row">
                      <span class="flex items-center gap-2">
                        <span class="text-[11px] font-semibold text-slate-500">27 NOV</span>
                        <span>Festa Rara</span>
                      </span>
                      <i class="ri-arrow-right-s-line text-xs text-slate-400"></i>
                    </button>
                    <button class="w-full text-left aprio-mini-list-row">
                      <span class="flex items-center gap-2">
                        <span class="text-[11px] font-semibold text-slate-500">30 NOV</span>
                        <span>Dismantle · Mainstage</span>
                      </span>
                      <i class="ri-arrow-right-s-line text-xs text-slate-400"></i>
                    </button>
                    <button class="w-full text-left aprio-mini-list-row">
                      <span class="flex items-center gap-2">
                        <span class="text-[11px] font-semibold text-slate-500">07 DEZ</span>
                        <span>Domply Mergulho</span>
                      </span>
                      <i class="ri-arrow-right-s-line text-xs text-slate-400"></i>
                    </button>
                  </div>
                ...
                <section>
                  <div class="flex items-center justify-between mb-1">
                    <div class="flex items-center gap-2">
                      <span class="font-semibold text-slate-700">Núcleos</span>
                ...
                <section>
                  <div class="flex items-center justify-between mb-1">
                    <div class="flex items-center gap-2">
                      <span class="font-semibold text-slate-700">Comunidades</span>
                ...
                <section>
                  <div class="flex items-center justify-between mb-1">
                    <div class="flex items-center gap-2">
                      <span class="font-semibold text-slate-700">Docs</span>
                      <span class="aprio-mini-pill">Últimos</span>
                    </div>
                    <button class="aprio-mini-link">
                      ver todos
                      <i class="ri-arrow-right-s-line text-xs"></i>
