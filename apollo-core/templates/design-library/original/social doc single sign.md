...
<head>
  <meta charset="UTF-8" />
  <title>Apollo :: Assinar Documento</title>
...
<body class="min-h-screen">
  <div class="min-h-screen flex bg-slate-50">
    ...
    <!-- SIDEBAR DESKTOP: APOLLO SOCIAL (geral para todos usuários) -->
  ...
  <!-- SIDEBAR DESKTOP: APOLLO SOCIAL -->
    ...
    <!-- MAIN COLUMN: PÁGINA DE ASSINATURA -->
    <div class="flex-1 flex flex-col h-full relative overflow-hidden bg-slate-50/50">
        ...
        <div class="px-4 h-16 flex items-center justify-between max-w-7xl mx-auto w-full">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="hidden md:flex flex-col leading-tight ml-2">
              <h1 class="text-xl font-bold text-slate-900">Assinatura de Documento</h1>
          ...
          <!-- Right: Status/Meta -->
          <div class="flex items-center gap-3">
            <span id="doc-status-pill-header" class="hidden md:inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-medium text-amber-700">
      ...
      <main class="flex-1 overflow-y-auto scroll-smooth relative p-4 md:p-6" id="mainContainer">
        ...
        <div class="hidden md:flex items-center gap-2 text-[11px] text-slate-500 mb-4 max-w-7xl mx-auto px-1">
          <span class="hover:text-slate-900 cursor-pointer">Documentos</span>
          <span class="text-slate-300">/</span>
          <span class="text-slate-900 font-medium truncate" id="bc-doc-title">Termo de Responsabilidade · Evento</span>
        </div>
        ...
        <div class="max-w-7xl mx-auto w-full h-full flex flex-col lg:flex-row gap-6 pb-20 md:pb-0">
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar">
                  <div class="max-w-[600px] mx-auto bg-white shadow-lg border border-slate-100 min-h-[600px] p-8 md:p-12 text-slate-800 text-sm leading-relaxed space-y-4">
                    <div class="flex justify-between items-start border-b border-slate-100 pb-4 mb-4">
                      ...
                      <div class="h-8 w-8 bg-slate-900 rounded-full flex items-center justify-center text-white">
                    ...
                    <p>
                      A assinatura digital realizada por meio de conta gov.br ou certificado digital ICP-Brasil confere
          ...
          <div class="w-full lg:w-[380px] shrink-0 flex flex-col gap-4">
            ...
            <section class="bg-white rounded-3xl shadow-sm border border-slate-200 p-5">
              ...
              <div class="space-y-3">
                <!-- User (You) -->
                <div id="signer-you-card" class="flex items-center justify-between p-3 rounded-xl bg-amber-50 border border-amber-100">
                  <div class="flex items-center gap-3">
                  ...
                  <span id="signer-you-status" class="flex items-center gap-1 text-[10px] font-bold text-amber-600 bg-white px-2 py-1 rounded-full shadow-sm">
                ...
                <div class="flex items-center justify-between p-3 rounded-xl bg-white border border-slate-100">
                  ...
                  <span class="flex items-center gap-1 text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full">
  ...
  <!-- Script simples para simular assinatura -->
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function handleSign(provider) {
        ...
        if (signedAt) signedAt.textContent = 'Data: ' + formatted;
        if (signedCode) signedCode.textContent = 'Cod: ' + provider.toUpperCase() + '-' + Math.floor(Math.random() * 999999).toString().padStart(6, '0');
        if (signedHash) signedHash.textContent = 'Hash: ' + generateFakeHash();
        ...
        if (headerPill) {
          ...
          headerPill.innerHTML = '<span class="inline-flex h-2 w-2 rounded-full bg-emerald-500"></span> Assinado';
        }
        ...
        if (signerYouCard && signerYouStatus) {
          ...
          signerYouStatus.innerHTML = '<i class="ri-check-line"></i> Assinado';
        }

        if (signCountLabel) {
          signCountLabel.textContent = '2/2';
        }
      }
