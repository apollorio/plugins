...
<head>
    ...
    <title>Festa Dismantle #2 - Apollo::rio</title>
...
/* Keep your overlay/content as you had */
.hero-overlay {
  position: absolute;
  top: 0;
  left: 0;
...
.hero-content {
  ...
  color: white;
            ...
            <div class="hero-content">
              <!-- START TAGS example:
<span class="event-tag-pill"><i class="ri-fire-fill"></i> NOVIDADE</span>
<span class="event-tag-pill"><i class="ri-award-fill"></i>Apollo recomenda</span>
<span class="event-tag-pill"><i class="ri-verified-badge-fill"></i> destaque</span>-->
              [$tags => <span class="event-tag-pill"><i class="XX"></i> $TAG_name </span>]
              <!-- END TAGS -->
                <h1 class="hero-title">[$EVENTO_NOME]</h1>
                <div class="hero-meta">
                    <div class="hero-meta-item">
                        <i class="ri-calendar-line"></i> 
                        <span> <!-- EXAMPLE: " 25 Out '25 " --> [$DAY] [$Month initials] '[YY]</span>
                    </div>
                    <div class="hero-meta-item">
                        <i class="ri-time-line"></i> 
                        <span id="Hora">[$Hora_inicio] - [$hora_fim]</span><font style="opacity:.7;font-weight:300; font-size:.81rem; vertical-hei; vertical-align: bottom;">(GMT-03h00)</font>
                    </div>
                    <div class="hero-meta-item">
                        <i class="ri-map-pin-line"></i> 
                        <span>[$Local_nome]</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- RSVP Row with Avatar Explosion = EXAMPLE TO REPLACE WITH USER AVATAR -->
<div class="rsvp-row">
...
<!-- Infinite span mandatory 1 --> <span class="music-tag">Techno</span>
                       <!-- Infinite span mandatory 2 --> <span class="music-tag">Industrial</span>
                     <!-- Infinite span mandatory 3 -->   <span class="music-tag">House</span>
                      <!-- Infinite span mandatory 4 -->  <span class="music-tag">Experimental</span>
                    <!-- Infinite span mandatory 5 -->    <span class="music-tag">Techno</span>
                     <!-- Infinite span mandatory 6 -->   <span class="music-tag">Industrial</span>
                   <!-- Infinite span mandatory 7 -->     <span class="music-tag">House</span>
                 <!-- Infinite span mandatory 8 -->       <span class="music-tag">Experimental</span>
                    </div>
                </div>
            </section>
...
<!-- IMAGE 01 -->
<div class="promo-slide"> <img src="[$URL_IMAGE1]" alt="Promo 1"></div>
<!-- IMAGE 02 -->                        
<div class="promo-slide"><img src="[$URL_IMAGE2]" alt="Promo 2"></div>
<!-- IMAGE 03 -->  
<div class="promo-slide"><img src="[$URL_IMAGE3]" alt="Promo 3"></div>
<!-- IMAGE 04 -->  
<div class="promo-slide"><img src="[$URL_IMAGE3]" alt="Promo 4"></div>
<!-- IMAGE 05 -->  
<div class="promo-slide"><img src="[$URL_IMAGE3]" alt="Promo 5"></div>          
</div>
...
<img src="[$DJ IMAGEorURL]" alt="[$DJ_NAME]" class="lineup-avatar-img"><div class="lineup-info"><h3 class="lineup-name"><a href="./dj/[$DJ_POST_CPT-dj]/" target="_blank" class="dj-link">[$DJ_NAME]</a></h3><div class="lineup-time"><i class="ri-time-line"></i><span>[$TIME_IN] - [$TIME_OUT]</span>                            </div>
</div>
</div>
 <!-- DJ X - WITH PHOTO -->
<div class="lineup-card">
...
<!-- Venue Section with 5 Images Infinite Carousel -->
            <section class="section" id="route_ROUTE">
                <h2 class="section-title">
                    <i class="ri-map-pin-2-line"></i> [$LOCAL_NAME]
                </h2>
                <p style="margin:0.5rem 0 1.5rem 0; font-size:0.95rem;">[$LOCAL_ADDRESS_FULL]S</p>
...
<img src="[$IMAGE_LOCAL_X-of-max5]" alt="Venue 1"></div>
<!-- SLIDER IMAGE X of max 5 -->  
<div class="local-image">
<img src="[$IMAGE_LOCAL_X-of-max5]" alt="Venue 2"></div>
<!-- SLIDER IMAGE X of max 5 -->  
<div class="local-image">
<img src="[$IMAGE_LOCAL_X-of-max5]" alt="Venue 3"></div>
<!-- SLIDER IMAGE X of max 5 -->  
<div class="local-image">
<img src="[$IMAGE_LOCAL_X-of-max5]" alt="Venue 4"></div>
<!-- SLIDER IMAGE X of max 5 -->  
<div class="local-image">
<img src="[$IMAGE_LOCAL_X-of-max5]" alt="Venue 5"></div>
...
<a href="[$EXTERNAL_URL]?ref=apollo.rio.br" class="ticket-card" target="_blank">
<div class="ticket-icon"><i class="ri-ticket-line"></i></div>
<div class="ticket-info">
<h3 class="ticket-name"><span id="changingword" style="opacity: 1;">Biglietti</span></h3><span class="ticket-cta">Acessar Bilheteria Digital →</span></div>
</a>
...
<img src="[$FINAL URL IMG]" alt="Event Final">
</div>
</section>
</div>
...
updateDots();
        ...
        if (routeBtn) { routeBtn.addEventListener('click', () => {
                ...
                if (origin) {
                    const destination = encodeURIComponent('Av. Rodrigues Alves, 293 - Saude, Rio de Janeiro'); window.open(`https://www.google.com/maps/dir/?api=1&origin=${encodeURIComponent(origin)}&destination=${destination}`, '_blank');
                } else {
