...
$terms_url        = apply_filters( 'apollo_auth_terms_url', $terms_url );
...
<form id="register-form" method="post" data-tooltip="<?php esc_attr_e( 'Formulário de registro', 'apollo-social' ); ?>">
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Campo de nome', 'apollo-social' ); ?>">
		<label for="nome"><?php esc_html_e( 'Nome social & Sobrenome', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<div class="input-wrapper">
			<span class="input-prefix">></span>
			<input type="text" id="nome" name="nome"
				placeholder="<?php esc_attr_e( 'Como você é conhecid@', 'apollo-social' ); ?>" autocomplete="name"
				required data-tooltip="<?php esc_attr_e( 'Digite seu nome social e sobrenome', 'apollo-social' ); ?>">
		</div>
	</div>
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Campo de Instagram', 'apollo-social' ); ?>">
		...
		<div class="input-wrapper">
			<span class="input-prefix" style="color: var(--color-accent); font-weight: bold;"
				data-tooltip="<?php esc_attr_e( 'Prefixo fixo @', 'apollo-social' ); ?>">@</span>
			<input type="text" id="instagram" name="instagram"
				placeholder="<?php esc_attr_e( 'seu_usuario', 'apollo-social' ); ?>" autocomplete="off"
				style="padding-left: 26px;"
				data-tooltip="<?php esc_attr_e( 'Digite apenas seu usuário sem @', 'apollo-social' ); ?>">
		</div>
		<p class="small-note"><?php esc_html_e( 'Será seu ID Apollo. Digite apenas o usuário.', 'apollo-social' ); ?>
		</p>
	</div>
	<?php endif; ?>
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Tipo de documento', 'apollo-social' ); ?>">
		<label for="doc_type"><?php esc_html_e( 'Tipo de Documento', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<div style="display: flex; gap: 12px; margin-bottom: 12px;">
			<label class="custom-toggle doc-type-toggle" data-type="cpf"
				data-tooltip="<?php esc_attr_e( 'Selecionar CPF', 'apollo-social' ); ?>">
				<div class="toggle-track" style="width: auto; padding: 6px 12px;">
					<span style="font-size: 11px;"><?php esc_html_e( 'CPF', 'apollo-social' ); ?></span>
				</div>
			</label>
			<label class="custom-toggle doc-type-toggle" data-type="passport"
				data-tooltip="<?php esc_attr_e( 'Selecionar Passaporte', 'apollo-social' ); ?>">
				<div class="toggle-track" style="width: auto; padding: 6px 12px;">
	...
	<div class="form-group" id="cpf-field" data-tooltip="<?php esc_attr_e( 'Campo de CPF', 'apollo-social' ); ?>">
		<label for="cpf"><?php esc_html_e( 'CPF', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<div class="input-wrapper">
			<span class="input-prefix">></span>
			<input type="text" id="cpf" name="cpf"
				placeholder="<?php esc_attr_e( '000.000.000-00', 'apollo-social' ); ?>" maxlength="14"
				autocomplete="off"
				data-tooltip="<?php esc_attr_e( 'Digite seu CPF (necessário para assinatura digital)', 'apollo-social' ); ?>">
		</div>
		<p class="small-note">
			<?php esc_html_e( 'Necessário para assinatura digital de documentos.', 'apollo-social' ); ?></p>
	</div>

	<!-- Passport Fields (hidden by default) -->
	<div class="form-group hidden" id="passport-field"
		data-tooltip="<?php esc_attr_e( 'Campo de Passaporte', 'apollo-social' ); ?>">
		<label for="passport"><?php esc_html_e( 'Número do Passaporte', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<div class="input-wrapper">
			<span class="input-prefix">></span>
			<input type="text" id="passport" name="passport"
				placeholder="<?php esc_attr_e( 'ABC123456', 'apollo-social' ); ?>" maxlength="20"
		...
		<div class="input-wrapper" style="margin-top: 10px;">
			...
			<input type="text" id="passport_country" name="passport_country"
				placeholder="<?php esc_attr_e( 'País de emissão', 'apollo-social' ); ?>" autocomplete="off"
				data-tooltip="<?php esc_attr_e( 'País que emitiu seu passaporte', 'apollo-social' ); ?>">
		</div>
		<!-- Passport Warning -->
		<div style="background: rgba(239,68,68,0.15); border: 1px solid rgba(239,68,68,0.4); border-radius: 8px; padding: 10px; margin-top: 10px;"
			data-tooltip="<?php esc_attr_e( 'Aviso importante para usuários com passaporte', 'apollo-social' ); ?>">
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Campo de e-mail', 'apollo-social' ); ?>">
		<label for="email"><?php esc_html_e( 'E-mail', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<div class="input-wrapper">
			<span class="input-prefix">></span>
			<input type="email" id="email" name="email"
				placeholder="<?php esc_attr_e( 'seu@email.com', 'apollo-social' ); ?>" autocomplete="email" required
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Campo de senha', 'apollo-social' ); ?>">
		<label for="senha"><?php esc_html_e( 'Crie sua chave de acesso', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<div class="input-wrapper">
			<span class="input-prefix">></span>
			<input type="password" id="senha" name="senha"
				placeholder="<?php esc_attr_e( 'mínimo 8 caracteres', 'apollo-social' ); ?>" minlength="8"
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Seleção de gêneros musicais', 'apollo-social' ); ?>">
		<label><?php esc_html_e( 'Gêneros Musicais', 'apollo-social' ); ?> <span
				style="color: var(--color-accent);">*</span></label>
		<p class="small-note" style="margin-bottom: 10px;">
			<?php esc_html_e( 'Selecione pelo menos 1 gênero que você curte.', 'apollo-social' ); ?></p>
		<div class="sounds-chips" style="display: flex; flex-wrap: wrap; gap: 8px;"
			data-tooltip="<?php esc_attr_e( 'Clique para selecionar', 'apollo-social' ); ?>">
			<?php foreach ( $available_sounds as $slug => $name ) : ?>
			<label class="quiz-chip sound-chip" data-value="<?php echo esc_attr( $slug ); ?>"
				data-tooltip="<?php echo esc_attr( $name ); ?>">
	...
	<div class="form-group" data-tooltip="<?php esc_attr_e( 'Aceite dos termos', 'apollo-social' ); ?>">
		<div class="custom-toggle terms-toggle"
			data-tooltip="<?php esc_attr_e( 'Clique para aceitar', 'apollo-social' ); ?>">
			...
			<span style="font-size: 11px; line-height: 1.4;">
				...
				<a href="<?php echo esc_url( $terms_url ); ?>" target="_blank" rel="noopener noreferrer"
					...
					data-tooltip="<?php esc_attr_e( 'Abrir em nova aba', 'apollo-social' ); ?>">
	...
	<button type="submit" class="btn-primary"
		style="width: 100% !important; background: linear-gradient(135deg, #ff8d7f, #ffb690) !important; border: 1px solid rgba(255, 255, 255, 0.15) !important; color: #fff !important; padding: 13px !important; border-radius: 999px !important; font-weight: 700 !important; font-size: 12px !important; letter-spacing: .18em !important; text-transform: uppercase !important; cursor: pointer !important; display: flex !important; align-items: center !important; justify-content: center !important; gap: 8px !important; box-shadow: 0 8px 24px rgba(249, 115, 22, 0.25) !important;"
		data-tooltip="<?php esc_attr_e( 'Prosseguir para o teste de aptidão', 'apollo-social' ); ?>">
...
<div style="text-align: center; margin-top: 20px;"
	data-tooltip="<?php esc_attr_e( 'Link para login', 'apollo-social' ); ?>">
	<p style="font-size: 12px; color: rgba(148,163,184,0.9);">
		<?php esc_html_e( 'Já possui acesso?', 'apollo-social' ); ?>
		<button type="button" class="btn-text" id="switch-to-login"
			data-tooltip="<?php esc_attr_e( 'Voltar para login', 'apollo-social' ); ?>">
