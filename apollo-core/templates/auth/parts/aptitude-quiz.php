...
<div class="aptitude-overlay" id="aptitude-overlay" data-tooltip="<?php esc_attr_e( 'Teste de Aptidão', 'apollo-social' ); ?>">
	...
	<div class="scroll-area" style="flex: 1; display: flex; flex-direction: column; justify-content: center;">
		...
		<div style="padding: 0 22px 20px; flex-shrink: 0;">
			<button type="button" id="test-btn" class="btn-primary" style="width: 100% !important; background: linear-gradient(135deg, #ff8d7f, #ffb690) !important; border: 1px solid rgba(255, 255, 255, 0.15) !important; color: #fff !important; padding: 13px !important; border-radius: 999px !important; font-weight: 700 !important; font-size: 12px !important; letter-spacing: .18em !important; text-transform: uppercase !important; cursor: pointer !important; display: flex !important; align-items: center !important; justify-content: center !important; gap: 8px !important; box-shadow: 0 8px 24px rgba(249, 115, 22, 0.25) !important;" disabled data-tooltip="<?php esc_attr_e( 'Botão de confirmação', 'apollo-social' ); ?>">
