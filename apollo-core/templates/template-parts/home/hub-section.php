<?php
/**
 * Apollo HUB Section - DJ/Artist Profile Card
 *
		...
		<div class="hub-grid">
			<div class="hub-card-wrapper reveal-up">
				<div class="hub-card" id="hubCard">
					...
					<div class="hub-links">
						<a href="<?php echo esc_url( $featured_dj['soundcloud'] ); ?>" class="hub-link hub-link-primary" target="_blank">
			...
			<div class="hub-content reveal-up delay-100">
				...
				<p class="hub-description">
					<?php esc_html_e( 'Uma página simples para todos os seus links. O Apollo é a mão extra que apoia toda a indústria, centralizando sua presença digital em um único ponto de contato.', 'apollo-core' ); ?>
				</p>
				<?php if ( ! is_user_logged_in() ) : ?>
					<a href="<?php echo esc_url( wp_registration_url() ); ?>" class="hub-cta smooth-transition">
						<?php esc_html_e( 'Criar minha conta', 'apollo-core' ); ?>
						<i class="ri-arrow-right-up-long-line"></i>
					</a>
				<?php else : ?>
					<a href="<?php echo esc_url( home_url( '/minha-conta/hub' ) ); ?>" class="hub-cta smooth-transition">
						<?php esc_html_e( 'Gerenciar meu HUB', 'apollo-core' ); ?>
						<i class="ri-arrow-right-up-long-line"></i>
					</a>
				<?php endif; ?>
			</div>
