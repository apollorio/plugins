...
if (! class_exists('Apollo_Core\Schema\CoreSchemaModule')) {
	class_alias(CoreSchemaModule::class, 'Apollo_Core\Schema\CoreSchemaModule');
}
...
class CoreSchemaModule implements SchemaModuleInterface
{
	...
	{
		return array(
			'apollo_mod_log'                 => array('actor_id_idx', 'action_idx', 'target_type_idx', 'target_id_idx', 'created_at_idx'),
			'apollo_audit_log'               => array('event_type_idx', 'actor_id_idx', 'severity_idx', 'created_at_idx'),
			'apollo_analytics_pageviews'     => array('session_idx', 'user_idx', 'page_type_idx', 'post_id_idx', 'created_at_idx', 'device_idx'),
			'apollo_analytics_interactions'  => array('session_idx', 'pageview_idx', 'user_idx', 'interaction_type_idx', 'created_at_idx'),
			'apollo_analytics_sessions'      => array('session_id_idx', 'user_idx', 'started_at_idx'),
			'apollo_analytics_user_stats'    => array('user_idx'),
			'apollo_analytics_content_stats' => array('content_idx'),
			'apollo_quiz_attempts'           => array('user_idx', 'quiz_idx'),
			'apollo_newsletter_subscribers'  => array('email_idx', 'status_idx'),
			'apollo_newsletter_campaigns'    => array('status_idx', 'scheduled_idx'),
		);
	}
