...
class Cena_Rio_Roles {
	...
	public static function init(): void {
		...
		add_action( 'admin_init', array( self::class, 'maybe_setup_roles' ) );
	}
	...
	public static function activate(): void {
		...
		if ( class_exists( 'Apollo_Core\Cena_Rio_Canvas' ) ) {
			Cena_Rio_Canvas::flush_rewrite_rules();
		}
	}
...
// Initialize.
Cena_Rio_Roles::init();
Cena_Rio_Roles::setup_apollo_capabilities();
