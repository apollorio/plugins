...
class Response {
	 ...
	 * @return WP_REST_Response
	 */
	public static function created( mixed $data, string $message = 'Recurso criado com sucesso' ): WP_REST_Response {
...
if ( ! function_exists( 'apollo_api_response' ) ) {
	...
	function apollo_api_response(): string {
		return \Apollo_Core\API\Response::class;
	}
}
