...
class Email_Admin_UI {
	...
	public static function init(): void {
		...
		add_action( 'wp_ajax_apollo_email_save_flow', array( self::class, 'ajax_save_flow' ) );
		add_action( 'wp_ajax_apollo_email_send_test', array( self::class, 'ajax_send_test' ) );
		add_action( 'wp_ajax_apollo_email_preview', array( self::class, 'ajax_preview' ) );
	}
	...
	private static function render_templates_section( array $templates ): void {
		...
		<div class="card" style="margin-top: 20px;">
			...
			<p>
				<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=apollo_email_temp' ) ); ?>"
					class="button button-primary">
					<?php esc_html_e( 'Create New Template', 'apollo-core' ); ?>
				</a>
				<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=apollo_email_temp' ) ); ?>"
					class="button">
	...
	public static function ajax_send_test(): void {
		...
		$email_service = Email_Service::instance();
