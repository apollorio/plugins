...
class Cookie_Consent {
	...
	public static function init(): void {
		...
		if ( is_admin() ) {
			...
			// add_action( 'admin_notices', array( __CLASS__, 'show_admin_status' ) ); // DISABLED - annoying popup
		}
	}
	...
	public static function show_admin_status(): void {
		...
		if ( ! $screen || false === strpos( $screen->id, 'apollo' ) ) {
			return;
		}
	 ...
	 */
	public static function can_load_analytics( bool $can_load ): bool {
...
// Initialize on init.
add_action( 'init', array( Cookie_Consent::class, 'init' ) );
