...
function create_db_tables(): void {
	...
	// User sounds table (Phase 3.2.0) - music genre preferences for matchmaking.
	if ( function_exists( 'apollo_create_user_sounds_table' ) ) {
		apollo_create_user_sounds_table();
	}
