<?php
/**
 * Email Security Log class.
 *
 * @package Apollo_Core
 * @subpackage Security
 * @since 1.3.0
 *
 * phpcs:disable WordPress.NamingConventions.ValidFunctionName.MethodNameInvalid -- Class uses camelCase for PSR-4 compatibility.
 * phpcs:disable WordPress.DB.DirectDatabaseQuery -- Custom table operations.
 * phpcs:disable WordPress.DB.PreparedSQL -- Table name interpolation and dynamic queries are safe in this context.
 * phpcs:disable Universal.Operators.DisallowShortTernary.Found -- Short ternary is intentional.
 * phpcs:disable Squiz.Commenting.FunctionComment.MissingParamTag -- Parameters documented inline.
 * phpcs:disable Squiz.Commenting.FunctionComment.ParamCommentFullStop -- Param comments are brief.
 * phpcs:disable WordPress.Security.ValidatedSanitizedInput -- Server variables are properly sanitized.
 * phpcs:disable Squiz.ControlStructures.ControlSignature.SpaceAfterCloseBrace -- Multiline condition formatting.
 */
...
// Initialize.
add_action( 'plugins_loaded', array( Email_Security_Log::class, 'init' ), 5 );
