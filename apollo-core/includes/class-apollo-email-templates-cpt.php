...
class Email_Templates_CPT {
	 ...
	 * @var string
	 */
	public const POST_TYPE = 'apollo_email_temp';
	...
	public static function add_meta_boxes(): void {
		...
		add_meta_box(
			'apollo_email_temp_placeholders',
			__( 'Available Placeholders', 'apollo-core' ),
			array( __CLASS__, 'render_placeholders_box' ),
			self::POST_TYPE,
			'normal',
			'low'
		);
	...
	public static function render_meta_box( \WP_Post $post ): void {
		wp_nonce_field( 'apollo_email_temp_meta', 'apollo_email_temp_nonce' );
	...
	public static function save_meta( int $post_id ): void {
		...
		if ( ! isset( $_POST['apollo_email_temp_nonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['apollo_email_temp_nonce'] ) ), 'apollo_email_temp_meta' ) ) {
			return;
		}
