...
$is_modal = defined('APOLLO_MODAL_CONTEXT') && APOLLO_MODAL_CONTEXT;
...
<div class="mobile-container">
        ...
        <div class="hero-content">
            ...
            <section id="listing_types_tags_category">
                <?php if ($event_data['special_badge']): ?>
                    ...
                    if ($badge === 'Apollo recomenda') $badge_icon = 'ri-award-fill';
                    elseif ($badge === 'Destaque') $badge_icon = 'ri-verified-badge-fill';
                    ?>
    ...
    <div class="event-body">
                    ...
                    if (!empty($sounds)):
                        ...
                        while (count($repeated) < $total_needed) {
                            foreach ($sound_list as $sound) {
                                $repeated[] = $sound;
                                if (count($repeated) >= $total_needed) break;
                            }
                        }
                    ...
                    <div class="lineup-info">
                        ...
                        <div class="lineup-time">
                            ...
                            <span>
                                ...
                                <?php if ($dj_end): ?> - <?php echo esc_html($dj_end); ?><?php endif; ?>
                            </span>
                        </div>
                        <?php endif; ?>
                    </div>
        ...
        <section class="section" id="route_TICKETS">
            ...
            <div class="tickets-grid">
                ...
                <div class="apollo-coupon-detail" data-coupon-code="<?php echo esc_attr($event_data['coupon'] ?: 'APOLLO'); ?>">
                    ...
                    <span><?php printf(esc_html__('Verifique se o cupom %s está ativo com desconto', 'apollo-events-manager'),
                        '<strong>' . esc_html($event_data['coupon'] ?: 'APOLLO') . '</strong>'); ?></span>
        ...
        <section class="section" id="route_REGISTROS">
            ...
            <div class="registros-container">
                ...
                <div class="registros-list">
                    <?php foreach ($comments as $comment): 
                        $author_avatar = get_avatar_url($comment->comment_author_email, ['size' => 48]);
            ...
            <style>
            .registros-container { margin-top: 1rem; }
            .registros-list { display: flex; flex-direction: column; gap: 1rem; margin-bottom: 1.5rem; }
            .registro-card {
                display: flex;
                gap: 0.75rem;
                padding: 1rem;
            ...
            .registro-author { font-weight: 600; font-size: 0.875rem; }
            .registro-date { font-size: 0.75rem; opacity: 0.5; }
            .registro-text { font-size: 0.875rem; line-height: 1.5; margin: 0; opacity: 0.9; }
            .registros-empty {
                text-align: center;
                padding: 2rem;
            ...
            .registros-empty p { margin: 0.5rem 0 0; opacity: 0.5; font-size: 0.875rem; }
            ...
            .registro-submit:hover { transform: scale(1.05); }
            .registro-login-prompt { text-align: center; margin-top: 1rem; }
            .registro-login-btn {
                display: inline-flex;
                align-items: center;
                gap: 0.5rem;
            ...
            .registro-login-btn:hover { background: rgba(255,255,255,0.1); }
            </style>
        </section>
...
function copyPromoCode(btn) {
    ...
    if (navigator.clipboard) {
        navigator.clipboard.writeText(coupon).then(function() {
            ...
            setTimeout(function() { icon.className = 'ri-file-copy-fill'; }, 2000);
        });
    }
}
