...
?>
        ...
        if (empty($event_ids)) {
            ...
            if (empty($filtered_ids)) {
                ...
                // phpcs:ignore WordPress.WP.DeprecatedFunctions.update_post_term_cacheFound -- Core WP function, not deprecated.
                if (function_exists('update_object_term_cache')) {
                    update_object_term_cache(wp_list_pluck($events, 'ID'), 'event_listing');
                }
