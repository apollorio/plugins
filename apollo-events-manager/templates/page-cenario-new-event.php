				...
				<div class="space-y-4">
					<div>
						...
						<input
							...
							placeholder="<?php esc_attr_e('Ex: Tomorrowland Brasil 2025', 'apollo-events-manager'); ?>">
					</div>
					...
					<div>
						...
						<textarea
							...
							class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
							placeholder="<?php esc_attr_e('Descreva o evento, line-up, atrações especiais...', 'apollo-events-manager'); ?>"></textarea>
					</div>
				</div>
			</div>
				...
				<div class="space-y-4">
					...
					<div>
						...
						<input
							...
							name="event_location"
							class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
							placeholder="<?php esc_attr_e('Nome do local | Área', 'apollo-events-manager'); ?>">
						<p class="mt-1 text-sm text-muted-foreground">
							<?php esc_html_e('Use se nenhum local foi selecionado acima', 'apollo-events-manager'); ?>
						</p>
					</div>
				...
				<div class="space-y-4">
					<div>
						...
						<input
							...
							name="event_banner"
							class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
							placeholder="<?php esc_attr_e('https://...', 'apollo-events-manager'); ?>">
						<p class="mt-1 text-sm text-muted-foreground">
					...
					<div>
						...
						<input
							...
							class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
							placeholder="<?php esc_attr_e('https://www.youtube.com/watch?v=...', 'apollo-events-manager'); ?>">
						<p class="mt-1 text-sm text-muted-foreground">
				...
				<div class="space-y-4">
					<div>
						...
						<input
							...
							name="tickets_ext"
							class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
							placeholder="<?php esc_attr_e('https://sympla.com.br/...', 'apollo-events-manager'); ?>">
					</div>
	...
	if (isset($_POST['apollo_event_timetable']) && ! empty($_POST['apollo_event_timetable'])) {
		...
		if (is_array($timetable) && function_exists('apollo_sanitize_timetable')) {
			...
			if (! empty($clean_timetable)) {
				apollo_update_post_meta($event_id, '_event_dj_slots', $clean_timetable);
			}
		}
	}
