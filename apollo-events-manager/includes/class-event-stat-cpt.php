...
class Apollo_Event_Stat_CPT {
    ...
    private static function get_or_create_stat_post($event_id) {
        ...
        $stat_post_id = wp_insert_post(array(
            'post_type' => 'apollo_event_stat',
