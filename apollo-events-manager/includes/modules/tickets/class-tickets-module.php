...
class Tickets_Module extends Abstract_Module {
    ...
    public function enqueue_assets(): void {
        ...
        wp_localize_script( 'apollo-tickets', 'apolloTickets', array(
