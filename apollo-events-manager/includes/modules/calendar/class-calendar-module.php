...
class Calendar_Module extends Abstract_Module {
    ...
    public function init(): void {
        ...
        add_action( 'wp_ajax_apollo_calendar_navigate', [ $this, 'ajax_navigate' ] );
        add_action( 'wp_ajax_nopriv_apollo_calendar_navigate', [ $this, 'ajax_navigate' ] );
    }
    ...
    public function register_shortcodes(): void {
        add_shortcode( 'apollo_calendar', [ $this, 'render_calendar' ] );
        add_shortcode( 'apollo_calendar_week', [ $this, 'render_calendar_week' ] );
        add_shortcode( 'apollo_mini_calendar', [ $this, 'render_mini_calendar' ] );
    }
    ...
    public function register_assets(): void {
        ...
        wp_localize_script( 'apollo-calendar', 'apolloCalendar', [
