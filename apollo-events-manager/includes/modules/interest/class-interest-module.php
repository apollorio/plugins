...
class Interest_Module extends Abstract_Module {
    ...
    public function enqueue_assets(): void {
        ...
        wp_localize_script( 'apollo-interest', 'apolloInterest', array(
            'ajaxUrl'     => admin_url( 'admin-ajax.php' ),
            'nonce'       => wp_create_nonce( 'apollo_interest_nonce' ),
    ...
    private function render_interest_card( int $event_id ): void {
        ...
        <article class="apollo-event-card apollo-interest-card">
            ...
            <div class="apollo-interest-card__actions">
                <?php echo $this->render_interest_button( array( 'event_id' => $event_id, 'show_count' => 'false', 'size' => 'small' ) ); ?>
            </div>
        </article>
        <?php
    }
    ...
    public function ajax_toggle_interest(): void {
        check_ajax_referer( 'apollo_interest_nonce', 'nonce' );
