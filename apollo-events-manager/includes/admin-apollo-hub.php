...
function apollo_events_hub_admin_styles($hook) {
    ...
    wp_enqueue_style(
        ...
        plugins_url('assets/css/admin-hub.css', dirname(__FILE__)),
        [],
        '1.0.0'
    );
}
...
function apollo_events_render_settings_content() {
    ...
    if (isset($_POST['apollo_events_settings_nonce']) && 
        wp_verify_nonce($_POST['apollo_events_settings_nonce'], 'apollo_events_save_settings')) {
...
function apollo_events_get_all_shortcodes() {
    return [
        'Eventos' => [
            ['code' => '[events]', 'description' => 'Lista de eventos com filtros', 'attributes' => 'per_page, show_filters, show_map'],
            ['code' => '[event id="123"]', 'description' => 'Exibe um evento específico', 'attributes' => 'id'],
            ['code' => '[event_summary id="123"]', 'description' => 'Resumo compacto do evento', 'attributes' => 'id'],
            ['code' => '[past_events]', 'description' => 'Lista de eventos passados', 'attributes' => 'per_page'],
            ['code' => '[upcoming_events]', 'description' => 'Próximos eventos', 'attributes' => 'per_page, days'],
            ['code' => '[related_events]', 'description' => 'Eventos relacionados', 'attributes' => 'per_page'],
        ],
        'DJs' => [
            ['code' => '[event_djs]', 'description' => 'Lista de DJs', 'attributes' => 'per_page'],
            ['code' => '[single_event_dj id="123"]', 'description' => 'Página single de DJ', 'attributes' => 'id'],
            ['code' => '[apollo_dj_profile]', 'description' => 'Perfil do DJ atual', 'attributes' => ''],
        ],
        'Locais' => [
            ['code' => '[event_locals]', 'description' => 'Lista de locais', 'attributes' => 'per_page'],
            ['code' => '[single_event_local id="123"]', 'description' => 'Página single de local', 'attributes' => 'id'],
            ['code' => '[local_dashboard]', 'description' => 'Dashboard do local', 'attributes' => ''],
        ],
        'Formulários' => [
            ['code' => '[submit_event_form]', 'description' => 'Formulário de submissão de evento', 'attributes' => ''],
            ['code' => '[submit_dj_form]', 'description' => 'Formulário de cadastro de DJ', 'attributes' => ''],
            ['code' => '[submit_local_form]', 'description' => 'Formulário de cadastro de local', 'attributes' => ''],
            ['code' => '[apollo_public_event_form]', 'description' => 'Formulário público de evento', 'attributes' => ''],
        ],
        'Dashboards' => [
            ['code' => '[event_dashboard]', 'description' => 'Dashboard de eventos do usuário', 'attributes' => ''],
            ['code' => '[dj_dashboard]', 'description' => 'Dashboard do DJ', 'attributes' => ''],
            ['code' => '[my_apollo_dashboard]', 'description' => 'Dashboard completo My Apollo', 'attributes' => ''],
            ['code' => '[apollo_user_dashboard]', 'description' => 'Dashboard geral do usuário', 'attributes' => ''],
        ],
        'Favoritos' => [
            ['code' => '[favorite_button]', 'description' => 'Botão de favoritar', 'attributes' => 'post_id'],
            ['code' => '[favorite_count]', 'description' => 'Contador de favoritos', 'attributes' => 'post_id'],
            ['code' => '[user_favorites]', 'description' => 'Lista de favoritos do usuário', 'attributes' => ''],
            ['code' => '[user_favorite_count]', 'description' => 'Total de favoritos do usuário', 'attributes' => ''],
            ['code' => '[apollo_bookmarks]', 'description' => 'Bookmarks salvos', 'attributes' => ''],
        ],
        'Autenticação' => [
            ['code' => '[apollo_register]', 'description' => 'Formulário de registro', 'attributes' => ''],
            ['code' => '[apollo_login]', 'description' => 'Formulário de login', 'attributes' => 'redirect'],
        ],
    ];
}
...
function apollo_events_get_all_placeholders() {
    return [
        'Evento' => [
            ['code' => '{event_title}', 'description' => 'Título do evento', 'example' => 'Festa Techno'],
            ['code' => '{event_date}', 'description' => 'Data do evento', 'example' => '25/12/2025'],
            ['code' => '{event_time}', 'description' => 'Horário do evento', 'example' => '23:00'],
            ['code' => '{event_location}', 'description' => 'Local do evento', 'example' => 'Club XYZ'],
            ['code' => '{event_address}', 'description' => 'Endereço completo', 'example' => 'Rua ABC, 123'],
            ['code' => '{event_description}', 'description' => 'Descrição do evento', 'example' => 'Lorem ipsum...'],
            ['code' => '{event_banner}', 'description' => 'URL do banner', 'example' => 'https://...'],
            ['code' => '{event_url}', 'description' => 'URL do evento', 'example' => 'https://site.com/evento/...'],
            ['code' => '{event_djs}', 'description' => 'Lista de DJs', 'example' => 'DJ A, DJ B'],
        ],
        'DJ' => [
            ['code' => '{dj_name}', 'description' => 'Nome do DJ', 'example' => 'Marta Supernova'],
            ['code' => '{dj_tagline}', 'description' => 'Tagline do DJ', 'example' => 'Electro from Rio'],
            ['code' => '{dj_bio}', 'description' => 'Biografia', 'example' => 'Lorem ipsum...'],
            ['code' => '{dj_soundcloud}', 'description' => 'URL SoundCloud', 'example' => 'https://soundcloud.com/...'],
            ['code' => '{dj_instagram}', 'description' => 'Handle Instagram', 'example' => '@djname'],
            ['code' => '{dj_avatar}', 'description' => 'URL da foto', 'example' => 'https://...'],
        ],
        'Local' => [
            ['code' => '{local_name}', 'description' => 'Nome do local', 'example' => 'Club XYZ'],
            ['code' => '{local_address}', 'description' => 'Endereço', 'example' => 'Rua ABC, 123'],
            ['code' => '{local_city}', 'description' => 'Cidade', 'example' => 'Rio de Janeiro'],
            ['code' => '{local_capacity}', 'description' => 'Capacidade', 'example' => '500'],
            ['code' => '{local_map_lat}', 'description' => 'Latitude', 'example' => '-22.9068'],
            ['code' => '{local_map_lng}', 'description' => 'Longitude', 'example' => '-43.1729'],
        ],
        'Usuário' => [
            ['code' => '{user_name}', 'description' => 'Nome do usuário', 'example' => 'João Silva'],
            ['code' => '{user_email}', 'description' => 'Email', 'example' => 'joao@email.com'],
            ['code' => '{user_avatar}', 'description' => 'Avatar URL', 'example' => 'https://...'],
        ],
    ];
}
...
function apollo_events_get_all_forms() {
    return [
        [
            ...
            'fields' => [
                ['label' => 'Título do Evento', 'type' => 'text', 'required' => true, 'meta_key' => 'post_title'],
                ['label' => 'Data do Evento', 'type' => 'date', 'required' => true, 'meta_key' => '_event_start_date'],
                ['label' => 'Horário', 'type' => 'time', 'required' => true, 'meta_key' => '_event_start_time'],
                ['label' => 'Local', 'type' => 'select', 'required' => true, 'meta_key' => '_event_local_ids'],
                ['label' => 'DJs', 'type' => 'multiselect', 'required' => false, 'meta_key' => '_event_dj_ids'],
                ['label' => 'Banner', 'type' => 'file', 'required' => false, 'meta_key' => '_event_banner'],
                ['label' => 'Descrição', 'type' => 'textarea', 'required' => false, 'meta_key' => 'post_content'],
            ],
        ],
        [
            'name' => 'Cadastro de DJ',
            ...
            'permission' => 'Usuários logados (subscriber+)',
            'fields' => [
                ['label' => 'Nome Artístico', 'type' => 'text', 'required' => true, 'meta_key' => '_dj_name'],
                ['label' => 'Tagline', 'type' => 'text', 'required' => false, 'meta_key' => '_dj_tagline'],
                ['label' => 'Bio', 'type' => 'textarea', 'required' => false, 'meta_key' => '_dj_bio'],
                ['label' => 'Foto', 'type' => 'file', 'required' => false, 'meta_key' => '_dj_image'],
                ['label' => 'SoundCloud', 'type' => 'url', 'required' => false, 'meta_key' => '_dj_soundcloud'],
                ['label' => 'Instagram', 'type' => 'text', 'required' => false, 'meta_key' => '_dj_instagram'],
                ['label' => 'Roles', 'type' => 'text', 'required' => false, 'meta_key' => '_dj_roles'],
            ],
        ],
        [
            ...
            'permission' => 'Usuários logados (subscriber+)',
            'fields' => [
                ['label' => 'Nome do Local', 'type' => 'text', 'required' => true, 'meta_key' => '_local_name'],
                ['label' => 'Endereço', 'type' => 'text', 'required' => true, 'meta_key' => '_local_address'],
                ['label' => 'Cidade', 'type' => 'text', 'required' => true, 'meta_key' => '_local_city'],
                ['label' => 'Capacidade', 'type' => 'number', 'required' => false, 'meta_key' => '_local_capacity'],
                ['label' => 'Latitude', 'type' => 'text', 'required' => false, 'meta_key' => '_local_map_lat'],
                ['label' => 'Longitude', 'type' => 'text', 'required' => false, 'meta_key' => '_local_map_lng'],
            ],
        ],
    ];
}
    ...
    return [
        'capabilities' => [
            'edit_events' => [
                ...
                'admin' => true, 'editor' => true, 'author' => true, 'subscriber' => false
            ],
            'publish_events' => [
                'label' => 'Publicar Eventos',
                'admin' => true, 'editor' => true, 'author' => false, 'subscriber' => false
            ],
            'delete_events' => [
            ...
            'manage_event_settings' => [
                ...
                'admin' => true, 'editor' => false, 'author' => false, 'subscriber' => false
            ],
        ...
        'custom_roles' => [
            ['name' => 'Apollo Moderator', 'slug' => 'apollo', 'description' => 'Pode moderar eventos, DJs e locais pendentes'],
            ['name' => 'CENA-RIO User', 'slug' => 'cena_role', 'description' => 'Usuário da indústria - pode submeter eventos'],
            ['name' => 'CENA-RIO Moderator', 'slug' => 'cena_moderator', 'description' => 'Moderador interno do CENA-RIO'],
        ],
    ];
}
} // End if (!function_exists('apollo_events_get_all_shortcodes'))
...
function apollo_events_get_all_metakeys() {
    return [
        'Evento (event_listing)' => [
            ['key' => '_event_start_date', 'type' => 'date', 'description' => 'Data de início', 'example' => '2025-12-25'],
            ['key' => '_event_end_date', 'type' => 'date', 'description' => 'Data de término', 'example' => '2025-12-26'],
            ['key' => '_event_start_time', 'type' => 'time', 'description' => 'Horário de início', 'example' => '23:00'],
            ['key' => '_event_end_time', 'type' => 'time', 'description' => 'Horário de término', 'example' => '06:00'],
            ['key' => '_event_banner', 'type' => 'int|url', 'description' => 'Banner do evento', 'example' => '123 ou URL'],
            ['key' => '_event_local_ids', 'type' => 'string', 'description' => 'IDs dos locais', 'example' => '1,2,3'],
            ['key' => '_event_dj_ids', 'type' => 'string', 'description' => 'IDs dos DJs', 'example' => '10,20,30'],
            ['key' => '_event_timetable', 'type' => 'json', 'description' => 'Timetable JSON', 'example' => '[{"dj":1,"time":"23:00"}]'],
            ['key' => '_event_ticket_url', 'type' => 'url', 'description' => 'URL de ingressos', 'example' => 'https://...'],
            ['key' => '_event_price', 'type' => 'string', 'description' => 'Preço', 'example' => 'R$ 50,00'],
            ['key' => '_apollo_cena_status', 'type' => 'string', 'description' => 'Status CENA-RIO', 'example' => 'expected|confirmed'],
        ],
        'DJ (event_dj)' => [
            ['key' => '_dj_name', 'type' => 'string', 'description' => 'Nome artístico', 'example' => 'Marta Supernova'],
            ['key' => '_dj_tagline', 'type' => 'string', 'description' => 'Tagline', 'example' => 'Electro from Rio'],
            ['key' => '_dj_roles', 'type' => 'string', 'description' => 'Roles (vírgula)', 'example' => 'DJ, Producer'],
            ['key' => '_dj_bio', 'type' => 'text', 'description' => 'Biografia completa', 'example' => 'Lorem ipsum...'],
            ['key' => '_dj_bio_excerpt', 'type' => 'text', 'description' => 'Bio resumida', 'example' => 'Lorem...'],
            ['key' => '_dj_image', 'type' => 'int|url', 'description' => 'Foto principal', 'example' => '123'],
            ['key' => '_dj_soundcloud', 'type' => 'url', 'description' => 'URL SoundCloud', 'example' => 'https://soundcloud.com/...'],
            ['key' => '_dj_soundcloud_track', 'type' => 'url', 'description' => 'Track em destaque', 'example' => 'https://soundcloud.com/...'],
            ['key' => '_dj_track_title', 'type' => 'string', 'description' => 'Título da track', 'example' => 'Mix Set 2025'],
            ['key' => '_dj_spotify', 'type' => 'url', 'description' => 'URL Spotify', 'example' => 'https://spotify.com/...'],
            ['key' => '_dj_youtube', 'type' => 'url', 'description' => 'URL YouTube', 'example' => 'https://youtube.com/...'],
            ['key' => '_dj_instagram', 'type' => 'string', 'description' => 'Handle Instagram', 'example' => '@djname'],
            ['key' => '_dj_twitter', 'type' => 'string', 'description' => 'Handle Twitter', 'example' => '@djname'],
            ['key' => '_dj_tiktok', 'type' => 'string', 'description' => 'Handle TikTok', 'example' => '@djname'],
            ['key' => '_dj_facebook', 'type' => 'url', 'description' => 'URL Facebook', 'example' => 'https://facebook.com/...'],
            ['key' => '_dj_media_kit_url', 'type' => 'url', 'description' => 'URL Media Kit', 'example' => 'https://drive.google.com/...'],
            ['key' => '_dj_rider_url', 'type' => 'url', 'description' => 'URL Rider Técnico', 'example' => 'https://drive.google.com/...'],
            ['key' => '_dj_original_project_1', 'type' => 'string', 'description' => 'Projeto 1', 'example' => 'Apollo::rio'],
            ['key' => '_dj_original_project_2', 'type' => 'string', 'description' => 'Projeto 2', 'example' => 'Dismantle'],
            ['key' => '_dj_original_project_3', 'type' => 'string', 'description' => 'Projeto 3', 'example' => ''],
            ['key' => '_dj_more_platforms', 'type' => 'string', 'description' => 'Outras plataformas', 'example' => 'Bandcamp, Beatport'],
        ],
        'Local (event_local)' => [
            ['key' => '_local_name', 'type' => 'string', 'description' => 'Nome do local', 'example' => 'Club XYZ'],
            ['key' => '_local_address', 'type' => 'string', 'description' => 'Endereço', 'example' => 'Rua ABC, 123'],
            ['key' => '_local_city', 'type' => 'string', 'description' => 'Cidade', 'example' => 'Rio de Janeiro'],
            ['key' => '_local_state', 'type' => 'string', 'description' => 'Estado', 'example' => 'RJ'],
            ['key' => '_local_country', 'type' => 'string', 'description' => 'País', 'example' => 'Brasil'],
            ['key' => '_local_zipcode', 'type' => 'string', 'description' => 'CEP', 'example' => '22000-000'],
            ['key' => '_local_capacity', 'type' => 'int', 'description' => 'Capacidade', 'example' => '500'],
            ['key' => '_local_map_lat', 'type' => 'float', 'description' => 'Latitude', 'example' => '-22.9068'],
            ['key' => '_local_map_lng', 'type' => 'float', 'description' => 'Longitude', 'example' => '-43.1729'],
            ['key' => '_local_map_zoom', 'type' => 'int', 'description' => 'Zoom do mapa', 'example' => '15'],
            ['key' => '_local_image', 'type' => 'int|url', 'description' => 'Foto do local', 'example' => '456'],
            ['key' => '_local_website', 'type' => 'url', 'description' => 'Website', 'example' => 'https://clubxyz.com'],
            ['key' => '_local_instagram', 'type' => 'string', 'description' => 'Instagram', 'example' => '@clubxyz'],
        ],
    ];
}
