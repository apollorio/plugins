...
class Apollo_Events_Dashboards {
    ...
    public function __construct() {
        add_action('admin_menu', array($this, 'add_dashboard_menus'));
    ...
    public function add_dashboard_menus() {
        ...
        add_submenu_page(
            ...
            array($this, 'render_events_dashboard')
        );
        ...
        add_submenu_page(
            ...
            'edit_posts',
            'apollo-dj-dashboard',
            array($this, 'render_dj_dashboard')
        );
    }
    ...
    public function enqueue_dashboard_assets($hook) {
        ...
        wp_localize_script('apollo-dashboards', 'apolloDashboards', array(
