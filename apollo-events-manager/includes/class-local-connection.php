...
class Apollo_Local_Connection {
	...
	private function __construct() {
		...
		add_action( 'save_post_event_listing', array( $this, 'enforce_mandatory_connection' ), 10, 2 );

		// Validate before save (prevent saving without local)
		add_action( 'save_post_event_listing', array( $this, 'validate_local_connection' ), 5, 2 );
	}
