...
class Apollo_Post_Types {
    ...
    public function register_post_types() {
        ...
        $dj_args = array(
            ...
            'show_in_menu'        => true,
            'query_var'           => true,
            'rewrite'             => array('slug' => 'dj', 'with_front' => false),
            'capability_type'     => 'post',
            'has_archive'         => true,
            'hierarchical'        => false,
            'menu_position'       => 6,
    ...
    public function register_taxonomies() {
        ...
        register_taxonomy('event_listing_category', 'event_listing', array(
            ...
            'rewrite'           => array('slug' => 'categoria-evento', 'with_front' => false),
        ));
        ...
        register_taxonomy('event_listing_type', 'event_listing', array(
            'labels'            => $type_labels,
            'hierarchical'      => true,
            'show_ui'           => true,
            'show_admin_column' => true,
            ...
            'rewrite'           => array('slug' => 'tipo-evento', 'with_front' => false),
        ));
        ...
        register_taxonomy('event_listing_tag', 'event_listing', array(
            'labels'            => $tag_labels,
            'hierarchical'      => false,
            'show_ui'           => true,
            'show_admin_column' => true,
            ...
            'rewrite'           => array('slug' => 'tag-evento', 'with_front' => false),
        ));
        ...
        register_taxonomy('event_sounds', 'event_listing', array(
            ...
            'rewrite'           => array('slug' => 'som', 'with_front' => false),
        ));
    ...
    public function register_meta_fields() {
        ...
        $event_meta_fields = array(
            '_event_title'       => 'string',
            '_event_banner'      => 'string', // URL or attachment ID
            ...
            '_cupom_ario'        => 'integer', // 0 or 1
            '_event_dj_ids'      => 'string', // Serialized array
            '_event_local_ids'   => 'integer', // Single Local ID
            '_event_timetable'   => 'string', // Serialized array
            '_3_imagens_promo'   => 'string', // Serialized array of image URLs
            '_imagem_final'      => 'string', // Serialized array
            '_favorites_count'   => 'integer',
        );
        
        foreach ($event_meta_fields as $meta_key => $type) {
            register_post_meta('event_listing', $meta_key, array(
                'show_in_rest'      => true,
                'single'            => true,
                'type'              => $type,
        ...
        foreach ($local_meta_fields as $meta_key => $type) {
            register_post_meta('event_local', $meta_key, array(
                'show_in_rest'      => true,
                'single'            => true,
                'type'              => $type,
        ...
        foreach ($dj_meta_fields as $meta_key => $type) {
            register_post_meta('event_dj', $meta_key, array(
                'show_in_rest'      => true,
                'single'            => true,
                'type'              => $type,
                'sanitize_callback' => 'sanitize_text_field',
