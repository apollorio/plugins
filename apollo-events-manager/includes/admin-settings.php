...
class Apollo_Events_Admin_Settings {
    ...
    public function add_settings_page() {
        ...
        public function register_settings() {
            ...
            register_setting('apollo_events_settings', 'apollo_events_auto_create_eventos_page', array(
                'type' => 'boolean',
        ...
        // Fallback Banner URL
        register_setting('apollo_events_settings', 'apollo_events_fallback_banner_url', array(
            'type' => 'string',
        ...
        add_settings_field(
            ...
            array($this, 'render_fallback_banner_field'),
            'apollo-events-settings',
            'apollo_events_images'
        );
        
        // Usar Loading Animation
        register_setting('apollo_events_settings', 'apollo_events_use_loading_animation', array(
            'type' => 'boolean',
            'sanitize_callback' => 'rest_sanitize_boolean',
            'default' => true
        ));
        ...
        add_settings_field(
            ...
            array($this, 'render_loading_animation_field'),
            'apollo-events-settings',
            'apollo_events_images'
        );
    }
