...
function apollo_get_all_shortcodes_documentation() {
    ...
    $shortcode_metadata = array(
        ...
        'apollo_event_user_overview' => array(
        ...
        'apollo_public_event_form' => array(
...
function apollo_show_shortcode_documentation_on_activation() {
    ...
    if (!get_transient('apollo_show_docs_on_activation')) {
        return; // Not activated or already shown
    }
...
add_action('wp_ajax_apollo_dismiss_shortcode_docs', function() {
