...
class APRIO_REST_Send_Message_Controller extends APRIO_REST_CRUD_Controller
{
    ...
    public function register_routes()
    {
        ...
        register_rest_route(
            ...
            [
                ...
                'callback'            => [ $this, 'aprio_send_compatibilidade_messages' ],
        ...
        register_rest_route(
            ...
            [
                ...
                'callback'            => [ $this, 'aprio_get_compatibilidade_messages' ],
                'permission_callback' => [ $this, 'check_user_permission' ],
                'args'                => [
                    'senderId' => [
                        'required'          => true,
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [ $this, 'aprio_get_compatibilidade_conversation_list' ],
                'permission_callback' => [ $this, 'check_user_permission' ],
                'args'                => [
                    'user_id' => [
                        'required'          => true,
    ...
    public function aprio_get_compatibilidade_conversation_list($request)
    {
        ...
        if ($auth_check) {
             ...
             */
            $conversation_user_ids = $wpdb->get_col(
                $wpdb->prepare(
                    "
