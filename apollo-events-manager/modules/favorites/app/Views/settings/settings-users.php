...
<div class="simple-favorites-display-settings">
	<div class="row">
		...
		<div class="field">
			<label class="block"><input type="checkbox" name="simplefavorites_users[anonymous][display]" value="true" 
			<?php
            if ($this->settings_repo->anonymous('display')) {
                echo ' checked';
            }
?>
			data-favorites-anonymous-checkbox /><?php _e('Enable Anonymous Users', 'favorites'); ?>
			</label>
			<label class="block" data-favorites-anonymous-count><input type="checkbox" name="simplefavorites_users[anonymous][save]" value="true" 
			<?php
if ($this->settings_repo->anonymous('save')) {
    echo ' checked';
}
?>
	...
	<div class="row">
		...
		<div class="field">
			<label class="block"><input type="checkbox" name="simplefavorites_users[consent][require]" value="true" 
			<?php
if ($this->settings_repo->consent('require')) {
    echo ' checked';
}
?>
			data-favorites-require-consent-checkbox /><?php _e('Require User Consent', 'favorites'); ?>
			</label>
			<div class="require-consent-modal-content" data-favorites-require-consent-modal-content>
				...
				<?php
        wp_editor(
            $this->settings_repo->consent('modal'),
            'simplefavorites_users_authentication_modal',
            [
...
?>
	...
	<div class="row" data-favorites-require-login>
		...
		<div class="field">
			<label class="block"><input type="checkbox" name="simplefavorites_users[require_login]" value="true" 
			<?php
            if ($this->settings_repo->requireLogin()) {
                echo ' checked';
            }
?>
			data-favorites-require-login-checkbox data-favorites-anonymous-settings="modal" /><?php _e('Show Buttons and Display Modal for Anonymous Users', 'favorites'); ?>
			</label>
			<label class="block"><input type="checkbox" name="simplefavorites_users[redirect_anonymous]" value="true" 
			<?php
if ($this->settings_repo->redirectAnonymous()) {
    echo ' checked';
}
?>
			data-favorites-redirect-anonymous-checkbox data-favorites-anonymous-settings="redirect" /><?php _e('Redirect Anonymous Users to a Page', 'favorites'); ?>
			</label>
			<div class="authentication-modal-content" data-favorites-authentication-modal-content>
				...
				<?php
        wp_editor(
            $this->settings_repo->authenticationModalContent(true),
            'simplefavorites_users_authentication_modal',
            [
...
?>
	...
	<div class="row">
		...
		<div class="field">
			<label class="block"><input type="radio" name="simplefavorites_users[anonymous][saveas]" value="cookie" 
			<?php
            if ($this->settings_repo->saveType() == 'cookie') {
                echo 'checked';
            }
?>
			...
			<label>
				<input type="radio" name="simplefavorites_users[anonymous][saveas]" value="session" 
				<?php
    if ($this->settings_repo->saveType() == 'session') {
        echo 'checked';
    }
?>
