...
<div class="simple-favorites-post-types">
	<div class="post-type-row">
		<div class="post-type-checkbox">
			<input type="checkbox" name="simplefavorites_cache_enabled" value="true" 
			<?php
...
<div class="simple-favorites-post-types">
	<div class="post-type-row">
		<div class="post-type-checkbox">
			<input type="checkbox" name="simplefavorites_dev_mode" value="true" 
			<?php
			if ( $this->settings_repo->devMode() ) {
				echo 'checked';}
			?>
			/>
		</div>
...
<div class="simple-favorites-display-settings">
	<div class="row">
		...
		<div class="field">
			<label class="block"><input type="checkbox" name="simplefavorites_dependencies[css]" value="true" data-favorites-dependency-checkbox 
			<?php
			if ( $this->settings_repo->outputDependency( 'css' ) ) {
				echo 'checked';}
			?>
	...
	<div class="row">
		...
		<div class="field">
			<label class="block">
				<input type="checkbox" name="simplefavorites_dependencies[js]" value="true" data-favorites-dependency-checkbox 
				<?php
