...
return [
    'cpt' => ['event' => 'event_listing', 'dj' => 'event_dj', 'local' => 'event_local'],
    'tax' => ['category' => 'event_listing_category', 'type' => 'event_listing_type', 'tag' => 'event_listing_tag', 'sounds' => 'event_sounds'],
    'meta' => [
        'event' => [
